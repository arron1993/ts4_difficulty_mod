...
# Embedded file name: D:\dev\TS4\_deploy\Client\Releasex64\Python\Generated\protocolbuffers\Chat_pb2.py
# Compiled at: 2020-11-25 00:37:43
# Size of source mod 2**32: 4931 bytes
from google.protobuf import descriptor
from google.protobuf import message
from google.protobuf import reflection
from google.protobuf import descriptor_pb2
DESCRIPTOR = descriptor.FileDescriptor(name='Chat.proto',
...
_CHATPERSISTANCY_CHATGROUP_CHATGROUPUSER = descriptor.Descriptor(name='ChatGroupUser',
  full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup.ChatGroupUser',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='nucleusId',
   full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup.ChatGroupUser.nucleusId',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='name',
   full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup.ChatGroupUser.name',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
  ...
  serialized_end=259)
_CHATPERSISTANCY_CHATGROUP = descriptor.Descriptor(name='ChatGroup',
  full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='groupName',
   full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup.groupName',
   index=0,
   number=1,
   type=9,
   cpp_type=9,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='users',
   full_name='EA.Sims4.Chat.ChatPersistancy.ChatGroup.users',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
 ...
 _CHATPERSISTANCY_CHATGROUP_CHATGROUPUSER],
  ...
  serialized_end=259)
_CHATPERSISTANCY = descriptor.Descriptor(name='ChatPersistancy',
  full_name='EA.Sims4.Chat.ChatPersistancy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='groups',
   full_name='EA.Sims4.Chat.ChatPersistancy.groups',
   index=0,
   number=1,
   type=11,
   cpp_type=10,

...
# Embedded file name: D:\dev\TS4\_deploy\Client\Releasex64\Python\Generated\protocolbuffers\Loot_pb2.py
# Compiled at: 2020-11-25 00:38:57
...
DESCRIPTOR = descriptor.FileDescriptor(name='Loot.proto',
...
_SITUATIONENDED = descriptor.Descriptor(name='SituationEnded',
  full_name='EA.Sims4.Network.SituationEnded',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='icon_info',
   full_name='EA.Sims4.Network.SituationEnded.icon_info',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
   ...
   options=None),
 descriptor.FieldDescriptor(name='final_score',
   full_name='EA.Sims4.Network.SituationEnded.final_score',
   index=1,
   number=3,
   type=13,
   cpp_type=3,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='final_level',
   full_name='EA.Sims4.Network.SituationEnded.final_level',
   index=2,
   number=4,
   type=11,
   cpp_type=10,
 ...
 descriptor.FieldDescriptor(name='sim_ids',
   full_name='EA.Sims4.Network.SituationEnded.sim_ids',
   index=3,
   number=5,
   type=6,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='audio_sting',
   full_name='EA.Sims4.Network.SituationEnded.audio_sting',
   index=4,
   number=6,
   type=11,
   cpp_type=10,

...
# Embedded file name: D:\dev\TS4\_deploy\Client\Releasex64\Python\Generated\protocolbuffers\Clubs_pb2.py
# Compiled at: 2020-11-25 00:37:48
...
DESCRIPTOR = descriptor.FileDescriptor(name='Clubs.proto',
...
_CLUBCRITERIA_CLUBCRITERIACATEGORY = descriptor.EnumDescriptor(name='ClubCriteriaCategory',
  full_name='EA.Sims4.Network.ClubCriteria.ClubCriteriaCategory',
  filename=None,
  file=DESCRIPTOR,
  values=[
 descriptor.EnumValueDescriptor(name='SKILL',
   index=0,
   number=0,
   options=None,
   type=None),
 ...
 descriptor.EnumValueDescriptor(name='CAREER',
   ...
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='HOUSEHOLD_VALUE',
   index=4,
   number=4,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='AGE',
   index=5,
   number=5,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='CLUB_MEMBERSHIP',
   index=6,
   number=6,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='FAME_RANK',
   index=7,
   number=7,
   options=None,
   type=None)],
  ...
  serialized_end=415)
_CLUBINTERACTIONRULEUPDATE_CLUBINTERACTIONRULESTATUS = descriptor.EnumDescriptor(name='ClubInteractionRuleStatus',
  full_name='EA.Sims4.Network.ClubInteractionRuleUpdate.ClubInteractionRuleStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
 descriptor.EnumValueDescriptor(name='ENCOURAGED',
   index=0,
   number=0,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='DISCOURAGED',
   index=1,
   number=1,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='NO_EFFECT',
   index=2,
   number=2,
   options=None,
   type=None)],
  ...
  serialized_end=1157)
_CLUBCRITERIA = descriptor.Descriptor(name='ClubCriteria',
  full_name='EA.Sims4.Network.ClubCriteria',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='category',
   full_name='EA.Sims4.Network.ClubCriteria.category',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
   ...
   options=None),
 descriptor.FieldDescriptor(name='criteria_infos',
   full_name='EA.Sims4.Network.ClubCriteria.criteria_infos',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='multi_select',
   full_name='EA.Sims4.Network.ClubCriteria.multi_select',
   index=2,
   number=3,
   type=8,
   cpp_type=7,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='criteria_id',
   full_name='EA.Sims4.Network.ClubCriteria.criteria_id',
   index=3,
   number=4,
   type=13,
   cpp_type=3,
  ...
  nested_types=[],
  enum_types=[
 _CLUBCRITERIA_CLUBCRITERIACATEGORY],
  options=None,
  is_extendable=False,
  extension_ranges=[],
  serialized_start=84,
  serialized_end=415)
_CLUBCRITERIAINFO = descriptor.Descriptor(name='ClubCriteriaInfo',
  full_name='EA.Sims4.Network.ClubCriteriaInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='name',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.name',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
 ...
 descriptor.FieldDescriptor(name='icon',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.icon',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='resource_value',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.resource_value',
   index=2,
   number=3,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='enum_value',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.enum_value',
   index=3,
   number=4,
   type=13,
   cpp_type=3,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='resource_id',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.resource_id',
   index=4,
   number=5,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='tooltip_name',
   full_name='EA.Sims4.Network.ClubCriteriaInfo.tooltip_name',
   index=5,
   number=6,
   type=11,
   cpp_type=10,
  ...
  serialized_end=683)
_CLUBCONDUCTRULE = descriptor.Descriptor(name='ClubConductRule',
  full_name='EA.Sims4.Network.ClubConductRule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='encouraged',
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='interaction_group',
   full_name='EA.Sims4.Network.ClubConductRule.interaction_group',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='with_whom',
   full_name='EA.Sims4.Network.ClubConductRule.with_whom',
   index=2,
   number=3,
   type=11,
   cpp_type=10,
  ...
  serialized_end=832)
_CLUBBUILDINGINFO = descriptor.Descriptor(name='ClubBuildingInfo',
  full_name='EA.Sims4.Network.ClubBuildingInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='criterias',
   full_name='EA.Sims4.Network.ClubBuildingInfo.criterias',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='available_lots',
   full_name='EA.Sims4.Network.ClubBuildingInfo.available_lots',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
  ...
  serialized_end=958)
_CLUBINTERACTIONRULEUPDATE = descriptor.Descriptor(name='ClubInteractionRuleUpdate',
  full_name='EA.Sims4.Network.ClubInteractionRuleUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='rule_status',
   full_name='EA.Sims4.Network.ClubInteractionRuleUpdate.rule_status',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
  ...
  nested_types=[],
  enum_types=[
 _CLUBINTERACTIONRULEUPDATE_CLUBINTERACTIONRULESTATUS],
  options=None,
  is_extendable=False,
  extension_ranges=[],
  serialized_start=961,
  serialized_end=1157)
_SHOWCLUBINFOUI = descriptor.Descriptor(name='ShowClubInfoUI',
  full_name='EA.Sims4.Network.ShowClubInfoUI',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='club_id',
   full_name='EA.Sims4.Network.ShowClubInfoUI.club_id',
   index=0,
   number=1,
   type=4,
   cpp_type=4,

...
_BODYTYPESLIST = descriptor.Descriptor(name='BodyTypesList',
 ...
 descriptor.FieldDescriptor(name='body_types',
  ...
  serialized_start=55,
  serialized_end=94)
_COLORSHIFTLIST = descriptor.Descriptor(name='ColorShiftList',
  full_name='EA.Sims4.Persistence.ColorShiftList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='color_shift',
   full_name='EA.Sims4.Persistence.ColorShiftList.color_shift',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
  ...
  serialized_start=96,
  serialized_end=137)
_OUTFITDATA = descriptor.Descriptor(name='OutfitData',
  full_name='EA.Sims4.Persistence.OutfitData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='outfit_id',
   full_name='EA.Sims4.Persistence.OutfitData.outfit_id',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='category',
   full_name='EA.Sims4.Persistence.OutfitData.category',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='parts',
   full_name='EA.Sims4.Persistence.OutfitData.parts',
   index=2,
   number=5,
   type=11,
   cpp_type=10,
 ...
 descriptor.FieldDescriptor(name='created',
   full_name='EA.Sims4.Persistence.OutfitData.created',
   index=3,
   number=6,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='body_types_list',
   full_name='EA.Sims4.Persistence.OutfitData.body_types_list',
   index=4,
   number=7,
   type=11,
   cpp_type=10,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='match_hair_style',
   full_name='EA.Sims4.Persistence.OutfitData.match_hair_style',
   index=5,
   number=9,
   type=8,
   cpp_type=7,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='outfit_flags',
   full_name='EA.Sims4.Persistence.OutfitData.outfit_flags',
   index=6,
   number=10,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='outfit_flags_high',
   full_name='EA.Sims4.Persistence.OutfitData.outfit_flags_high',
   index=7,
   number=11,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='part_shifts',
   full_name='EA.Sims4.Persistence.OutfitData.part_shifts',
   index=8,
   number=12,
   type=11,
   cpp_type=10,
  ...
  serialized_end=445)
_OUTFITLIST = descriptor.Descriptor(name='OutfitList',
  full_name='EA.Sims4.Persistence.OutfitList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='outfits',
   full_name='EA.Sims4.Persistence.OutfitList.outfits',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
...
_PARTDATA = descriptor.Descriptor(name='PartData',
  full_name='EA.Sims4.Persistence.PartData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='id',
   full_name='EA.Sims4.Persistence.PartData.id',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='body_type',
   full_name='EA.Sims4.Persistence.PartData.body_type',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
   ...
   options=None),
 descriptor.FieldDescriptor(name='color_shift',
   full_name='EA.Sims4.Persistence.PartData.color_shift',
   index=2,
   number=3,
   type=4,
   cpp_type=4,
  ...
  serialized_end=595)
_PARTDATALIST = descriptor.Descriptor(name='PartDataList',
  full_name='EA.Sims4.Persistence.PartDataList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='parts',
   full_name='EA.Sims4.Persistence.PartDataList.parts',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
  ...
  serialized_end=658)
_GENETICDATA = descriptor.Descriptor(name='GeneticData',
  full_name='EA.Sims4.Persistence.GeneticData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='sculpts_and_mods_attr',
   full_name='EA.Sims4.Persistence.GeneticData.sculpts_and_mods_attr',
   index=0,
   number=1,
   type=12,
   cpp_type=9,
 ...
 descriptor.FieldDescriptor(name='physique',
   full_name='EA.Sims4.Persistence.GeneticData.physique',
   index=1,
   number=2,
   type=9,
   cpp_type=9,
 ...
 descriptor.FieldDescriptor(name='voice_pitch',
   full_name='EA.Sims4.Persistence.GeneticData.voice_pitch',
   index=2,
   number=3,
   type=2,
   cpp_type=6,
 ...
 descriptor.FieldDescriptor(name='voice_actor',
   full_name='EA.Sims4.Persistence.GeneticData.voice_actor',
   index=3,
   number=4,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='parts_list',
   full_name='EA.Sims4.Persistence.GeneticData.parts_list',
   index=4,
   number=5,
   type=11,
   cpp_type=10,
  ...
  serialized_end=821)
_PELTLAYERDATA = descriptor.Descriptor(name='PeltLayerData',
  full_name='EA.Sims4.Persistence.PeltLayerData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='layer_id',
   full_name='EA.Sims4.Persistence.PeltLayerData.layer_id',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='color',
   full_name='EA.Sims4.Persistence.PeltLayerData.color',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
  ...
  serialized_end=871)
_PELTLAYERDATALIST = descriptor.Descriptor(name='PeltLayerDataList',
  full_name='EA.Sims4.Persistence.PeltLayerDataList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='layers',
   full_name='EA.Sims4.Persistence.PeltLayerDataList.layers',
   index=0,
   number=1,
   type=11,
   cpp_type=10,

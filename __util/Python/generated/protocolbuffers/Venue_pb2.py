...
# Embedded file name: D:\dev\TS4\_deploy\Client\Releasex64\Python\Generated\protocolbuffers\Venue_pb2.py
# Compiled at: 2020-11-25 00:39:58
...
DESCRIPTOR = descriptor.FileDescriptor(name='Venue.proto',
...
_VETCLINICCONFIGURATION_VETCLINICOUTFITTYPE = descriptor.EnumDescriptor(name='VetClinicOutfitType',
  full_name='EA.Sims4.Network.VetClinicConfiguration.VetClinicOutfitType',
  filename=None,
  file=DESCRIPTOR,
  values=[
 descriptor.EnumValueDescriptor(name='MALE_EMPLOYEE',
   index=0,
   number=0,
   options=None,
   type=None),
 descriptor.EnumValueDescriptor(name='FEMALE_EMPLOYEE',
   index=1,
   number=1,
   options=None,
   type=None)],
...
_CAREEROUTFIT = descriptor.Descriptor(name='CareerOutfit',
  full_name='EA.Sims4.Network.CareerOutfit',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='outfit_index',
   full_name='EA.Sims4.Network.CareerOutfit.outfit_index',
   index=0,
   number=1,
   type=13,
   cpp_type=3,
   ...
   options=None),
 descriptor.FieldDescriptor(name='mannequin',
   full_name='EA.Sims4.Network.CareerOutfit.mannequin',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
  ...
  serialized_start=60,
  serialized_end=158)
_VETCLINICCONFIGURATION = descriptor.Descriptor(name='VetClinicConfiguration',
  full_name='EA.Sims4.Network.VetClinicConfiguration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='outfits',
   full_name='EA.Sims4.Network.VetClinicConfiguration.outfits',
   index=0,
   number=1,
   type=11,
   cpp_type=10,
  ...
  nested_types=[],
  enum_types=[
 _VETCLINICCONFIGURATION_VETCLINICOUTFITTYPE],
  options=None,
  is_extendable=False,
  extension_ranges=[],
  serialized_start=161,
  serialized_end=297)
_UNIVERSITYHOUSINGCONFIGURATION = descriptor.Descriptor(name='UniversityHousingConfiguration',
  full_name='EA.Sims4.Network.UniversityHousingConfiguration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='university_id',
   full_name='EA.Sims4.Network.UniversityHousingConfiguration.university_id',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='gender',
   full_name='EA.Sims4.Network.UniversityHousingConfiguration.gender',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='organization_id',
   full_name='EA.Sims4.Network.UniversityHousingConfiguration.organization_id',
   index=2,
   number=3,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='roommate_bed_count',
   full_name='EA.Sims4.Network.UniversityHousingConfiguration.roommate_bed_count',
   index=3,
   number=4,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='club_id',
   full_name='EA.Sims4.Network.UniversityHousingConfiguration.club_id',
   index=4,
   number=6,
   type=4,
   cpp_type=4,
  ...
  serialized_end=441)
_VENUEUPDATEREQUEST = descriptor.Descriptor(name='VenueUpdateRequest',
  full_name='EA.Sims4.Network.VenueUpdateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='venue_key',
   full_name='EA.Sims4.Network.VenueUpdateRequest.venue_key',
   index=0,
   number=1,
   type=6,
   cpp_type=4,
 ...
 descriptor.FieldDescriptor(name='lot_id',
   full_name='EA.Sims4.Network.VenueUpdateRequest.lot_id',
   index=1,
   number=2,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='world_id',
   full_name='EA.Sims4.Network.VenueUpdateRequest.world_id',
   index=2,
   number=3,
   type=13,
   cpp_type=3,

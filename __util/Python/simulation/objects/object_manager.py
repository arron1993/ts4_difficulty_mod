...
# Compiled at: 2020-07-29 02:13:37
# Size of source mod 2**32: 52769 bytes
...
class ObjectManager(DistributableObjectManager, GameObjectManagerMixin, AttractorManagerMixin):
 ...
 L.1122         0  LOAD_CONST               None
                2  STORE_FAST               'matching_objects'

 L.1123         4  SETUP_LOOP           86  'to 86'
                6  LOAD_FAST                'tags'
                8  GET_ITER         
             10_0  COME_FROM            78  '78'
               10  FOR_ITER             84  'to 84'
               12  STORE_FAST               'tag'

 L.1124        14  LOAD_FAST                'tag'
               16  LOAD_FAST                'self'
 ...
 L.1125        40  LOAD_FAST                'matching_objects'
               42  LOAD_CONST               None
               44  COMPARE_OP               is
               46  POP_JUMP_IF_FALSE    54  'to 54'

 L.1126        48  LOAD_FAST                'objs'
               50  STORE_FAST               'matching_objects'
               52  JUMP_BACK            10  'to 10'
             54_0  COME_FROM            46  '46'

 L.1127        54  LOAD_FAST                'match_any'
               56  POP_JUMP_IF_FALSE    68  'to 68'

 L.1128        58  LOAD_FAST                'matching_objects'
               60  LOAD_FAST                'objs'
               62  INPLACE_OR       
               64  STORE_FAST               'matching_objects'
               66  JUMP_BACK            10  'to 10'
             68_0  COME_FROM            56  '56'

 L.1130        68  LOAD_FAST                'matching_objects'
               70  LOAD_FAST                'objs'
               72  INPLACE_AND      
               74  STORE_FAST               'matching_objects'

 L.1131        76  LOAD_FAST                'matching_objects'
               78  POP_JUMP_IF_TRUE     10  'to 10'

 L.1132        80  BREAK_LOOP       
               82  JUMP_BACK            10  'to 10'
               84  POP_BLOCK        
             86_0  COME_FROM_LOOP        4  '4'

 L.1133        86  LOAD_FAST                'matching_objects'
               88  POP_JUMP_IF_FALSE    98  'to 98'
               90  LOAD_GLOBAL              frozenset
               92  LOAD_FAST                'matching_objects'
               94  CALL_FUNCTION_1       1  '1 positional argument'
               96  RETURN_VALUE     
             98_0  COME_FROM            88  '88'
               98  LOAD_GLOBAL              EMPTY_SET
              100  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `LOAD_FAST' instruction at offset 86

...
# Compiled at: 2020-08-03 19:47:07
# Size of source mod 2**32: 154446 bytes
        ...
        for inv in inventories:
            ...
            if contents_check is None:
                ...
                for item in inv:
                    ...
                    if content_check_type == self.ITEM_DEFINITION_TEST:
                        if contents_check.definition is not None and item_definition_id == contents_check.definition.id:
...
class ActiveRoutingObjectsTest(HasTunableSingletonFactory, AutoFactoryInit, event_testing.test_base.BaseTest):
    ...
    def __call__(self):
        ...
        object_count = routing_service.get_routing_object_count(self.tracking_category)

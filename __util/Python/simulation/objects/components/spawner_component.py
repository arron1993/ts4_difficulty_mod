...
# Compiled at: 2020-08-11 17:25:53
...
class SpawnerComponent(Component, HasTunableFactory, AutoFactoryInit, component_name=types.SPAWNER_COMPONENT, persistence_key=protocols.PersistenceMaster.PersistableData.SpawnerComponent):
 ...
 L. 681         0  LOAD_FAST                'ignore_firemeter'
 ...
 L. 682        30  LOAD_FAST                'spawn_firemeter_value'
               32  LOAD_CONST               None
               34  COMPARE_OP               is-not
               36  POP_JUMP_IF_FALSE    56  'to 56'

 L. 683        38  LOAD_GLOBAL              len
               40  LOAD_FAST                'self'
 ...
 L. 704       152  LOAD_CONST               None
              154  RETURN_VALUE     
            156_0  COME_FROM           150  '150'

 L. 706       156  LOAD_FAST                'spawn_result'
          158_160  POP_JUMP_IF_FALSE   300  'to 300'

 L. 707       162  LOAD_FAST                'spawn_result'
              164  LOAD_ATTR                spawner_option
              166  LOAD_ATTR                spawn_type
              168  STORE_DEREF              'spawn_type'

 L. 708       170  LOAD_DEREF               'spawn_type'
              172  LOAD_GLOBAL              SpawnerType
              174  LOAD_ATTR                GROUND
              176  COMPARE_OP               ==
              178  POP_JUMP_IF_FALSE   212  'to 212'

 L. 709       180  LOAD_FAST                'spawn_result'
              182  LOAD_ATTR                spawner_option
              184  LOAD_ATTR                radius
              186  STORE_FAST               'radius'

 L. 710       188  LOAD_FAST                'spawn_result'
              190  LOAD_ATTR                spawner_option
              192  LOAD_ATTR                min_radius
              194  STORE_FAST               'min_radius'

 L. 711       196  LOAD_FAST                'self'
              198  LOAD_METHOD              _create_object_on_ground
              200  LOAD_FAST                'spawn_result'
              202  LOAD_FAST                'radius'
              204  LOAD_FAST                'min_radius'
              206  LOAD_FAST                'force_initialization_spawn'
              208  CALL_METHOD_4         4  '4 positional arguments'
              210  POP_TOP          
            212_0  COME_FROM           178  '178'

 L. 712       212  LOAD_DEREF               'spawn_type'
              214  LOAD_GLOBAL              SpawnerType
              216  LOAD_ATTR                SLOT
              218  COMPARE_OP               ==
          220_222  POP_JUMP_IF_FALSE   300  'to 300'

 L. 713       224  LOAD_FAST                'spawn_result'
              226  LOAD_ATTR                spawner_option
              228  LOAD_ATTR                slot_type
              230  BUILD_SET_1           1 
              232  STORE_FAST               'slot_types'

 L. 716       234  LOAD_FAST                'force_initialization_spawn'
          236_238  POP_JUMP_IF_FALSE   264  'to 264'
              240  LOAD_FAST                'spawn_result'
              242  LOAD_ATTR                spawner_option
              244  LOAD_ATTR                force_initialization_spawn
              246  LOAD_CONST               None
              248  COMPARE_OP               is-not
          250_252  POP_JUMP_IF_FALSE   264  'to 264'

 L. 717       254  LOAD_FAST                'spawn_result'
              256  LOAD_ATTR                spawner_option
              258  LOAD_ATTR                force_initialization_spawn
              260  STORE_FAST               'create_object_count'
              262  JUMP_FORWARD        268  'to 268'
            264_0  COME_FROM           250  '250'
            264_1  COME_FROM           236  '236'

 L. 719       264  LOAD_FAST                'create_slot_obj_count'
              266  STORE_FAST               'create_object_count'
            268_0  COME_FROM           262  '262'

 L. 720       268  SETUP_LOOP          300  'to 300'
              270  LOAD_GLOBAL              range
              272  LOAD_FAST                'create_object_count'
              274  CALL_FUNCTION_1       1  '1 positional argument'
              276  GET_ITER         
              278  FOR_ITER            298  'to 298'
              280  STORE_FAST               '_'

 L. 721       282  LOAD_FAST                'self'
              284  LOAD_METHOD              _create_object_on_slot
              286  LOAD_FAST                'spawn_result'
              288  LOAD_FAST                'slot_types'
              290  CALL_METHOD_2         2  '2 positional arguments'
              292  POP_TOP          
          294_296  JUMP_BACK           278  'to 278'
              298  POP_BLOCK        
            300_0  COME_FROM_LOOP      268  '268'
            300_1  COME_FROM           220  '220'
            300_2  COME_FROM           158  '158'

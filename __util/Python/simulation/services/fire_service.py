...
# Compiled at: 2020-09-22 00:27:43
# Size of source mod 2**32: 88211 bytes
...
class FireService(Service):
    ...
    def is_object_flammable(self, obj):
        ...
        return tracker is None or tracker.has_statistic(self.FLAMMABLE_COMMODITY) or False
        return True

    def set_object_burning(self, obj):
        tracker = obj.get_tracker(self.FLAMMABLE_COMMODITY)
        return tracker is None or tracker.has_statistic(self.FLAMMABLE_COMMODITY) or None

...
# Compiled at: 2019-07-16 19:18:30
# Size of source mod 2**32: 20407 bytes
...
Parse error at or near `RETURN_VALUE' instruction at offset 76
    ...
    def create_photo_from_photo_data(cls, camera_mode, camera_quality, photographer_sim_id, target_obj_id, target_sim_ids, res_key, photo_style, photo_size, photo_orientation, photographer_sim_info, photographer_sim, time_stamp, selected_mood_param):
        ...
        is_paint_by_reference or cls._apply_quality_and_value_to_photo(photographer_sim, photo_object, photo_style, camera_quality)

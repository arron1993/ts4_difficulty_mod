...
# Compiled at: 2020-09-15 20:41:30
# Size of source mod 2**32: 95425 bytes
...
class CraftingProcess(ComponentContainer):
 ...
 CraftingTuning.STATIC_CRAFTING_COMMODITY,), 
    ...
    def __init__(self, sim=None, crafter=None, recipe=None, cost=None, paying_sim=None, reserved_ingredients=None, original_target=None, orderer_ids=None, ingredient_quality_bonus=None, funds_source=None, bucks_cost=None):
        super().__init__()
 ...
 L.1039         0  LOAD_FAST                'crafted_object'
 ...
 L.1040        16  LOAD_FAST                'crafted_object'
 ...
 L.1042        32  LOAD_CONST               None
               34  STORE_FAST               'owning_household_id'

 L.1043        36  LOAD_FAST                'owning_household_id_override'
               38  LOAD_CONST               None
               40  COMPARE_OP               is
               42  POP_JUMP_IF_FALSE   172  'to 172'

 L.1044        44  LOAD_FAST                'self'
 ...
 L.1064       194  LOAD_FAST                'self'
              196  LOAD_ATTR                recipe
              198  LOAD_METHOD              setup_crafted_object
...
Parse error at or near `CALL_METHOD_3' instruction at offset 208
 ...
 L.1635         0  LOAD_CONST               None
                2  STORE_FAST               'liabilities'

 L.1636         4  LOAD_FAST                'from_resume'
                6  POP_JUMP_IF_FALSE    26  'to 26'

 L.1637         8  LOAD_GLOBAL              CRAFTING_QUALITY_LIABILITY
 ...
 L.1639        26  LOAD_FAST                'next_phases'
               28  LOAD_CONST               None
               30  COMPARE_OP               is
               32  POP_JUMP_IF_FALSE   114  'to 114'

 L.1640        34  LOAD_FAST                'from_resume'
 ...
 L.1641        50  LOAD_CONST               None
               52  STORE_FAST               'phase'

 L.1642        54  LOAD_FAST                'self'
               56  LOAD_ATTR                orders
               58  POP_JUMP_IF_FALSE    82  'to 82'

 L.1643        60  LOAD_FAST                'self'
               62  LOAD_ATTR                orders
               64  LOAD_CONST               0
               66  BINARY_SUBSCR    

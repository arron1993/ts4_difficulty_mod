...
# Compiled at: 2020-09-30 23:19:02
# Size of source mod 2**32: 310663 bytes
...
class TransitionSequenceController:
 ...
 L.1235         0  BUILD_LIST_0          0 
                2  STORE_FAST               'sims_to_reset'

 L.1236         4  LOAD_CONST               False
                6  STORE_FAST               'moved_social_group'

 L.1237      8_10  SETUP_LOOP          366  'to 366'
               12  LOAD_FAST                'self'
 ...
 L.1238        32  LOAD_FAST                'derailed_reason'
               34  LOAD_CONST               None
               36  COMPARE_OP               is
 ...
 L.1239        50  CONTINUE             22  'to 22'
             52_0  COME_FROM            48  '48'

 L.1241        52  LOAD_FAST                'self'
 ...
 L.1248        68  SETUP_LOOP          164  'to 164'
               70  LOAD_FAST                'self'
 ...
 L.1252       112  LOAD_DEREF               'final_destination'
              114  LOAD_CONST               None
              116  COMPARE_OP               is-not
              118  POP_JUMP_IF_FALSE   164  'to 164'

 L.1258       120  LOAD_CLOSURE             'final_destination'
              122  BUILD_TUPLE_1         1 
 ...
 L.1267       232  LOAD_CONST               None
              234  LOAD_FAST                'self'
              236  STORE_ATTR               _original_interaction_target

 L.1268       238  LOAD_CONST               False
              240  LOAD_FAST                'self'
    ...
    def _get_specs_for_constraints(sim, interaction, interaction_constraint, pick=None, carry_target=None, used_hand_and_target=None):
        ...
        for posture_spec_template, posture_spec_vars, constraint in posture_specs_and_vars:
            ...
            if interaction is not None:
                ...
                if interaction.posture_preferences is not None and interaction.posture_preferences.prefer_clicked_part and pick is not None:
                ...
                if actor_path_spec.path:
                    if target_path_spec and target_path_spec.path:
                        ...
                        for transition in actor_path_spec.path:
                            if not transition is not None or transition[body_index][body_posture_type_index].multi_sim or self.interaction.require_shared_body_target:
            ...
            for sim in self.get_transitioning_sims():
                if sim in self._sim_data:
                    ...
                    if path_spec is not None:
                        ...
                        if len(path_spec.path) > 1 and path_spec.path[(-1)][BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                            if not path_spec.path[(-2)][BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                                continue
                ...
                for linked_sim_destination_posture_type in valid_exit_posture_types:
                    ...
                    if not source_posture_type.mobile:
                        ...
                        if body_target is None:
                            linked_destination_spec = linked_destination_spec.clone(surface=(PostureAspectSurface((None,
                                                                                                                   None,
                                                                                                                   None))))

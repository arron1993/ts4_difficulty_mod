...
# Compiled at: 2020-10-09 18:09:59
# Size of source mod 2**32: 410815 bytes
...
import build_buy, debugvis, element_utils, elements, event_testing.test_utils, gsi_handlers.posture_graph_handlers, indexed_manager, interactions.utils.routing, postures, primitives.routing_utils, routing, services, terrain
MAX_RIGHT_PATHS = 30
...
class TransitionSpec:
    ...
    def targets_empty_slot(self):
        ...
        if surface_spec[SURFACE_SLOT_TYPE_INDEX] is not None:
            if surface_spec[SURFACE_SLOT_TARGET_INDEX] is None:
                return True
        return False
 ...
 L.1119        96  LOAD_FAST                'reservation_spec'
               98  LOAD_CONST               None
 ...
 L.1130       178  LOAD_FAST                'target_si'
              180  LOAD_CONST               None
              182  COMPARE_OP               is-not
              184  POP_JUMP_IF_FALSE   196  'to 196'

 L.1131       186  LOAD_FAST                'target_si'
              188  STORE_FAST               'si'

 L.1132       190  LOAD_FAST                'si'
              192  LOAD_ATTR                sim
              194  STORE_DEREF              'sim'
            196_0  COME_FROM           184  '184'
            196_1  COME_FROM           164  '164'

 L.1133       196  LOAD_FAST                'si'
 ...
 L.1135       210  CONTINUE            140  'to 140'
            212_0  COME_FROM           208  '208'

 L.1137       212  LOAD_FAST                'si'
 ...
 L.1138       224  LOAD_FAST                'is_failure_path'
 ...
 L.1158       332  CONTINUE            140  'to 140'
            334_0  COME_FROM           310  '310'

 L.1160       334  LOAD_FAST                'si'
 ...
 L.1164       348  LOAD_CONST               False
              350  RETURN_VALUE     
            352_0  COME_FROM           344  '344'

 L.1169       352  LOAD_GLOBAL              can_remove_blocking_sims
              354  LOAD_DEREF               'sim'
              356  LOAD_FAST                'si'
 ...
 L.1181       454  LOAD_DEREF               'sim'
              456  LOAD_ATTR                queue
              458  LOAD_ATTR                transition_controller
              460  LOAD_METHOD              derail

 L.1182       462  LOAD_GLOBAL              DerailReason
 ...
 L.1200       556  LOAD_FAST                'target_set'
              558  LOAD_METHOD              add
 ...
 L.1201       570  SETUP_LOOP          662  'to 662'
 ...
 L.1203   614_616  CONTINUE            576  'to 576'
            618_0  COME_FROM           610  '610'
            618_1  COME_FROM           596  '596'

 L.1204       618  LOAD_GLOBAL              ReservationHandlerMulti
              620  LOAD_DEREF               'sim'
 ...
 L.1208       666  LOAD_FAST                'is_failure_path'
          668_670  POP_JUMP_IF_FALSE   676  'to 676'

 L.1209       672  LOAD_CONST               False
              674  RETURN_VALUE     
            676_0  COME_FROM           668  '668'

 L.1212       676  LOAD_FAST                'self'
              678  LOAD_ATTR                handle_slot_reservations
          680_682  POP_JUMP_IF_FALSE  1054  'to 1054'

 L.1215       684  BUILD_LIST_0          0 
              686  STORE_FAST               'object_to_ignore'

 L.1216       688  SETUP_LOOP          794  'to 794'
              690  LOAD_FAST                'self'
              692  LOAD_ATTR                _transition_interactions
              694  LOAD_DEREF               'sim'
              696  BINARY_SUBSCR    
              698  GET_ITER         
            700_0  COME_FROM           770  '770'
            700_1  COME_FROM           728  '728'
            700_2  COME_FROM           716  '716'
              700  FOR_ITER            792  'to 792'
              702  UNPACK_SEQUENCE_2     2 
              704  STORE_FAST               'transition_si'
              706  STORE_FAST               '_'

 L.1217       708  LOAD_GLOBAL              hasattr
              710  LOAD_FAST                'transition_si'
              712  LOAD_STR                 'process'
              714  CALL_FUNCTION_2       2  '2 positional arguments'
          716_718  POP_JUMP_IF_FALSE   700  'to 700'

 L.1218       720  LOAD_FAST                'transition_si'
              722  LOAD_ATTR                process
              724  LOAD_CONST               None
              726  COMPARE_OP               is-not
          728_730  POP_JUMP_IF_FALSE   700  'to 700'

 L.1219       732  LOAD_FAST                'transition_si'
              734  LOAD_ATTR                process
              736  LOAD_ATTR                previous_ico
              738  LOAD_CONST               None
              740  COMPARE_OP               is-not
          742_744  POP_JUMP_IF_FALSE   760  'to 760'

 L.1220       746  LOAD_FAST                'object_to_ignore'
              748  LOAD_METHOD              append
              750  LOAD_FAST                'transition_si'
              752  LOAD_ATTR                process
              754  LOAD_ATTR                previous_ico
              756  CALL_METHOD_1         1  '1 positional argument'
              758  POP_TOP          
            760_0  COME_FROM           742  '742'

 L.1221       760  LOAD_FAST                'transition_si'
              762  LOAD_ATTR                process
              764  LOAD_ATTR                current_ico
              766  LOAD_CONST               None
              768  COMPARE_OP               is-not
          770_772  POP_JUMP_IF_FALSE   700  'to 700'

 L.1222       774  LOAD_FAST                'object_to_ignore'
              776  LOAD_METHOD              append
              778  LOAD_FAST                'transition_si'
              780  LOAD_ATTR                process
              782  LOAD_ATTR                current_ico
              784  CALL_METHOD_1         1  '1 positional argument'
              786  POP_TOP          
          788_790  JUMP_BACK           700  'to 700'
              792  POP_BLOCK        
            794_0  COME_FROM_LOOP      688  '688'

 L.1227       794  LOAD_FAST                'self'
              796  STORE_FAST               'cur_spec'

 L.1228       798  BUILD_LIST_0          0 
              800  STORE_FAST               'slot_manifest_entries'

 L.1229       802  SETUP_LOOP          942  'to 942'
              804  LOAD_FAST                'cur_spec'
              806  LOAD_CONST               None
              808  COMPARE_OP               is-not
          810_812  POP_JUMP_IF_FALSE   940  'to 940'

 L.1230       814  LOAD_FAST                'cur_spec'
              816  LOAD_FAST                'self'
              818  COMPARE_OP               is-not
          820_822  POP_JUMP_IF_FALSE   838  'to 838'
              824  LOAD_FAST                'cur_spec'
              826  LOAD_ATTR                path
              828  LOAD_CONST               None
              830  COMPARE_OP               is-not
          832_834  POP_JUMP_IF_FALSE   838  'to 838'

 L.1233       836  BREAK_LOOP       
            838_0  COME_FROM           832  '832'
            838_1  COME_FROM           820  '820'

 L.1235       838  LOAD_FAST                'cur_spec'
              840  LOAD_ATTR                handle_slot_reservations
          842_844  POP_JUMP_IF_FALSE   924  'to 924'

 L.1238       846  LOAD_GLOBAL              PostureSpecVariable
              848  LOAD_ATTR                SLOT
              850  LOAD_FAST                'cur_spec'
              852  LOAD_ATTR                var_map
              854  COMPARE_OP               in
          856_858  POP_JUMP_IF_FALSE   900  'to 900'

 L.1239       860  LOAD_FAST                'cur_spec'
              862  LOAD_ATTR                var_map
              864  LOAD_GLOBAL              PostureSpecVariable
              866  LOAD_ATTR                SLOT
              868  BINARY_SUBSCR    
              870  STORE_FAST               'slot_entry'

 L.1240       872  LOAD_FAST                'slot_entry'
              874  LOAD_CONST               None
              876  COMPARE_OP               is-not
          878_880  POP_JUMP_IF_FALSE   924  'to 924'

 L.1241       882  LOAD_FAST                'slot_manifest_entries'
              884  LOAD_METHOD              append
              886  LOAD_FAST                'slot_entry'
              888  CALL_METHOD_1         1  '1 positional argument'
              890  POP_TOP          

 L.1242       892  LOAD_CONST               False
              894  LOAD_FAST                'cur_spec'
              896  STORE_ATTR               handle_slot_reservations
              898  JUMP_FORWARD        924  'to 924'
            900_0  COME_FROM           856  '856'

 L.1244       900  LOAD_GLOBAL              logger
              902  LOAD_METHOD              error
              904  LOAD_STR                 'Trying to reserve a surface with no PostureSpecVariable.SLOT in the var_map.\n    Sim: {}\n    Spec: {}\n    Var_map: {}\n    Transition: {}'

 L.1245       906  LOAD_DEREF               'sim'
              908  LOAD_FAST                'cur_spec'
              910  LOAD_FAST                'cur_spec'
              912  LOAD_ATTR                var_map
              914  LOAD_FAST                'cur_spec'
              916  LOAD_ATTR                _path_spec
              918  LOAD_ATTR                path
              920  CALL_METHOD_5         5  '5 positional arguments'
              922  POP_TOP          
            924_0  COME_FROM           898  '898'
            924_1  COME_FROM           878  '878'
            924_2  COME_FROM           842  '842'

 L.1246       924  LOAD_FAST                'self'
              926  LOAD_ATTR                _path_spec
              928  LOAD_METHOD              get_next_transition_spec
              930  LOAD_FAST                'cur_spec'
              932  CALL_METHOD_1         1  '1 positional argument'
              934  STORE_FAST               'cur_spec'
          936_938  JUMP_BACK           804  'to 804'
            940_0  COME_FROM           810  '810'
              940  POP_BLOCK        
            942_0  COME_FROM_LOOP      802  '802'

 L.1248       942  LOAD_FAST                'slot_manifest_entries'
          944_946  POP_JUMP_IF_FALSE  1054  'to 1054'

 L.1249       948  LOAD_FAST                'self'
              950  LOAD_ATTR                final_si
              952  LOAD_ATTR                animation_context
              954  STORE_FAST               'final_animation_context'

 L.1250       956  SETUP_LOOP         1054  'to 1054'
              958  LOAD_FAST                'slot_manifest_entries'
              960  GET_ITER         
            962_0  COME_FROM           984  '984'
              962  FOR_ITER           1052  'to 1052'
              964  STORE_FAST               'slot_manifest_entry'

 L.1251       966  LOAD_FAST                'final_animation_context'
              968  LOAD_ATTR                update_reserved_slots
              970  LOAD_FAST                'slot_manifest_entry'
              972  LOAD_DEREF               'sim'

 L.1252       974  LOAD_FAST                'object_to_ignore'
              976  LOAD_CONST               ('objects_to_ignore',)
              978  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
              980  STORE_FAST               'slot_result'

 L.1253       982  LOAD_FAST                'slot_result'
          984_986  POP_JUMP_IF_TRUE    962  'to 962'

 L.1254       988  LOAD_GLOBAL              set_transition_failure_reason
              990  LOAD_DEREF               'sim'
              992  LOAD_GLOBAL              TransitionFailureReasons
              994  LOAD_ATTR                RESERVATION

 L.1255       996  LOAD_FAST                'slot_manifest_entry'
              998  LOAD_ATTR                target
             1000  LOAD_CONST               None
             1002  COMPARE_OP               is-not
         1004_1006  POP_JUMP_IF_FALSE  1016  'to 1016'
             1008  LOAD_FAST                'slot_manifest_entry'
             1010  LOAD_ATTR                target
             1012  LOAD_ATTR                id
             1014  JUMP_FORWARD       1018  'to 1018'
           1016_0  COME_FROM          1004  '1004'
             1016  LOAD_CONST               None
           1018_0  COME_FROM          1014  '1014'
             1018  LOAD_CONST               ('target_id',)
             1020  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
             1022  POP_TOP          

 L.1256      1024  LOAD_DEREF               'cancel_reservations'
             1026  CALL_FUNCTION_0       0  '0 positional arguments'
             1028  POP_TOP          

 L.1257      1030  LOAD_GLOBAL              TestResult
             1032  LOAD_CONST               False
             1034  LOAD_STR                 'Slot Reservation Failed for {}'
             1036  LOAD_METHOD              format
             1038  LOAD_FAST                'self'
             1040  LOAD_ATTR                final_si
             1042  CALL_METHOD_1         1  '1 positional argument'
             1044  CALL_FUNCTION_2       2  '2 positional arguments'
             1046  RETURN_VALUE     
         1048_1050  JUMP_BACK           962  'to 962'
             1052  POP_BLOCK        
           1054_0  COME_FROM_LOOP      956  '956'
           1054_1  COME_FROM           944  '944'
           1054_2  COME_FROM           680  '680'

 L.1259      1054  LOAD_GLOBAL              TestResult
             1056  LOAD_ATTR                TRUE
             1058  RETURN_VALUE     
           1060_0  COME_FROM_EXCEPT     30  '30'

 L.1260      1060  POP_TOP          
             1062  POP_TOP          
             1064  POP_TOP          

 L.1261      1066  LOAD_DEREF               'cancel_reservations'
             1068  CALL_FUNCTION_0       0  '0 positional arguments'
             1070  POP_TOP          

 L.1262      1072  LOAD_GLOBAL              logger
             1074  LOAD_METHOD              exception
             1076  LOAD_STR                 'Exception reserving for transition: {}'
             1078  LOAD_FAST                'self'
             1080  CALL_METHOD_2         2  '2 positional arguments'
             1082  POP_TOP          

 L.1263      1084  RAISE_VARARGS_0       0  'reraise'
             1086  POP_EXCEPT       
             1088  JUMP_FORWARD       1092  'to 1092'
             1090  END_FINALLY      
           1092_0  COME_FROM          1088  '1088'

Parse error at or near `COME_FROM_EXCEPT' instruction at offset 1060_0
...
class PathSpec:
 ...
 L.1368        12  BUILD_LIST_0          0 
               14  LOAD_FAST                'self'
               16  STORE_ATTR               _path

 L.1369        18  SETUP_LOOP           92  'to 92'
               20  LOAD_FAST                'path'
               22  GET_ITER         
               24  FOR_ITER             50  'to 50'
               26  STORE_FAST               'posture_spec'

 L.1370        28  LOAD_FAST                'self'
               30  LOAD_ATTR                _path
               32  LOAD_METHOD              append
               34  LOAD_GLOBAL              TransitionSpec
               36  LOAD_FAST                'self'
 ...
 L.1372        54  LOAD_FAST                'path'
               56  LOAD_FAST                'self'
               58  STORE_ATTR               _path

 L.1373        60  LOAD_FAST                'self'
               62  LOAD_ATTR                _path
               64  LOAD_CONST               None
               66  COMPARE_OP               is-not
               68  POP_JUMP_IF_FALSE    92  'to 92'

 L.1374        70  SETUP_LOOP           92  'to 92'
               72  LOAD_FAST                'self'
               74  LOAD_ATTR                _path
               76  GET_ITER         
 ...
 L.1377        92  LOAD_FAST                'path_cost'
               94  LOAD_FAST                'self'
               96  STORE_ATTR               cost

 L.1379        98  LOAD_FAST                'destination_spec'
              100  LOAD_FAST                'self'
              102  STORE_ATTR               destination_spec

 L.1383       104  LOAD_CONST               False
              106  LOAD_FAST                'self'
              108  STORE_ATTR               completed_path

 L.1386       110  LOAD_CONST               0
              112  LOAD_FAST                'self'
              114  STORE_ATTR               _path_progress

 L.1389       116  LOAD_FAST                'is_failure_path'
              118  LOAD_FAST                'self'
              120  STORE_ATTR               _is_failure_path

 L.1391       122  LOAD_FAST                'failed_path_type'
              124  LOAD_FAST                'self'
              126  STORE_ATTR               _failed_path_type

 L.1396       128  LOAD_FAST                'allow_tentative'
 ...
 L.1402       168  LOAD_FAST                'final_constraint'
              170  LOAD_FAST                'self'
              172  STORE_ATTR               _final_constraint
            174_0  COME_FROM           166  '166'

 L.1404       174  LOAD_FAST                'spec_constraint'
              176  LOAD_FAST                'self'
              178  STORE_ATTR               _spec_constraint

 L.1406       180  LOAD_CONST               None
              182  LOAD_FAST                'self'
...
Parse error at or near `COME_FROM_LOOP' instruction at offset 92_3
    ...
    def create_route_nodes(self, path, portal_obj=None, portal_id=None):
        ...
        if not final_node.mobile:
            ...
            if len(posture_specs) == 1:
                new_transition_spec = TransitionSpec(self, (posture_specs[0]), (final_node.var_map), portal_obj=portal_obj,
                  portal_id=portal_id)
            else:
        ...
        for posture_spec in posture_specs[1:]:
            new_transition_spec = TransitionSpec(self, posture_spec, (final_node.var_map), portal_obj=portal_obj,
              portal_id=portal_id)
            self._path.append(new_transition_spec)
            ...
            if not transition_spec.posture_spec[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].unconstrained:
                if route_spec is None:
                    ...
                    if route_spec is None and not reverse:
                        if transition_spec.posture_spec[BODY_INDEX][BODY_TARGET_INDEX] is not None:
                            route_spec = previous_spec if previous_spec is not None else transition_spec
                        else:
                            if previous_spec is not None:
        ...
        if self.path is not None:
            if len(self.path) > 0:
                ...
                if body_posture_target is not None and sim.posture.mobile:
                    if self.path[0][BODY_INDEX][BODY_TARGET_INDEX] != body_posture_target:
    ...
    def remove_non_surface_to_surface_transitions(i, prev_transition_spec, transition_spec, next_transition_spec):
        ...
        if next_transition is not None:
            if prev_transition is None or prev_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                if transition[SURFACE_INDEX][SURFACE_TARGET_INDEX] is None:
                    if next_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                        if next_transition[SURFACE_INDEX][SURFACE_TARGET_INDEX] is not None:
    ...
    def remove_extra_mobile_transitions(i, prev_transition_spec, transition_spec, next_transition_spec):
        ...
        if prev_transition is None or next_transition is None:
            return (
             transition_spec,)
        if prev_transition[CARRY_INDEX] == next_transition[CARRY_INDEX]:
            if prev_transition[SURFACE_INDEX] == next_transition[SURFACE_INDEX]:
                if prev_transition[BODY_INDEX][BODY_TARGET_INDEX] == next_transition[BODY_INDEX][BODY_TARGET_INDEX]:
                    if transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX] == next_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX]:
                        return ()
        ...
        if prev_transition[CARRY_INDEX][CARRY_TARGET_INDEX] != transition[CARRY_INDEX][CARRY_TARGET_INDEX] or transition[CARRY_INDEX][CARRY_TARGET_INDEX] != next_transition[CARRY_INDEX][CARRY_TARGET_INDEX]:
            return (transition_spec,)
        if not prev_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
            if next_transition_spec.path is not None:
                return (
                 transition_spec,)
        if prev_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
            if transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                if next_transition[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
        ...
        for spec in specs:
            if slot_types:
                ...
                for slot_type in slot_types:
                    surface = PostureAspectSurface((spec.surface.target, slot_type,
                     spec.surface.slot_target))
...
class PostureGraphService(Service):
    ...
    def _expand_and_append_node_object(self, node, obj, out_ops):
        ...
        if obj.is_surface():
            ...
            parent = obj.parent
            if parent is not None and not obj.add_to_posture_graph_if_parented:
    ...
    def _validate_node_for_graph(node):
        ...
        if (surface is None or surface[SURFACE_TARGET_INDEX]) is None:
            if target is not None:
    ...
    def distance_fn(self, sim, var_map, interaction, curr_node, next_node):
        if isinstance(curr_node, _MobileNode):
            ...
            if curr_node == next_node:
                ...
                may_reserve_posture_target(sim, next_node, next_body_target) or cost += PostureScoring.OBJECT_RESERVED_PENALTY
            if gsi_handlers.posture_graph_handlers.archiver.enabled:
    ...
    def _adjacent_nodes_gen(self, sim, get_successors_fn, valid_edge_test, constraint, var_map, node, *, allow_pickups, allow_putdowns, allow_carried, reverse_path):
        ...
        def _edge_validation(forward_nodes, successor_node):
            if valid_edge_test is not None:
                ...
                return edge_info.validate(sim, var_map, original_body_target=node_body_target) or None
    ...
    def _left_path_gen(self, sim, source, destinations, interaction, constraint, var_map, valid_edge_test, is_complete):
        ...
        if is_complete:
            if source[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
                if source[SURFACE_INDEX][SURFACE_TARGET_INDEX] is None:
                    if not source[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].is_vehicle:
                        if all((dest[BODY_INDEX][BODY_TARGET_INDEX] != source[BODY_INDEX][BODY_TARGET_INDEX] for dest in destinations)):
                            return
            else:
    ...
    def _get_goal_cost(self, sim, interaction, constraint, var_map, dest):
        ...
        if node_target is not None:
            ...
            if final_constraint is None:
                final_constraint = constraint
            return final_constraint.valid or sims4.math.MAX_FLOAT
    ...
    def get_segmented_paths(self, sim, posture_dest_list, additional_template_list, interaction, participant_type, valid_destination_test, valid_edge_test, preferences, final_constraint, included_sis):
        ...
        for constraint, templates in posture_dest_list.items():
            ...
            if source_spec is None:
                continue
            if source_spec.body_posture.mobile and source_spec.body_posture.unconstrained and source_spec.body_target is not None and not source_spec.body_target.is_part:
                ...
                for node in self._graph.get_matching_nodes_gen(destination_specs, slot_types,
                ...
                if interaction.is_putdown and body_target_node_distances is not None:
            ...
            if allow_complete and source_node.body_target is None:
                ...
                if container is not sim:
                    ...
                    for prev_transition_spec, transition_spec in zip(best_transition_specs, best_transition_specs[1:]):
                        ...
                        pick_up_sequence = get_pick_up_spec_sequence(spec,
                          container,
                          body_target=(spec[BODY_INDEX][BODY_TARGET_INDEX]))
                        ...
                        for pick_up_spec in pick_up_sequence:
                            new_specs.append(TransitionSpec(best_path_spec, pick_up_spec, var_map_additional_updated,
                    ...
                    for prev_transition_spec, transition_spec in zip(best_transition_specs, best_transition_specs[1:]):
                        ...
                        if fallback_insertion_index_and_spec is None:
                            if spec[SURFACE_INDEX][SURFACE_TARGET_INDEX] is slot_manifest_entry.actor.parent:
                                fallback_insertion_index_and_spec = InsertionIndexAndSpec(insertion_index, spec)
                            if prev_transition_spec.posture_spec[CARRY_INDEX][CARRY_TARGET_INDEX] is not None and spec[CARRY_INDEX][CARRY_TARGET_INDEX] is None:
                                break
                    else:
                        if fallback_insertion_index_and_spec is not None:
                            insertion_index = fallback_insertion_index_and_spec.index
                            ...
                            continue
                        put_down_sequence = get_put_down_spec_sequence((spec[BODY_INDEX][BODY_POSTURE_TYPE_INDEX]),
                          (spec[SURFACE_INDEX][SURFACE_TARGET_INDEX]),
                          body_target=(spec[BODY_INDEX][BODY_TARGET_INDEX]))
                        new_specs = []
                        for put_down_spec in put_down_sequence:
                            new_specs.append(TransitionSpec(best_path_spec, put_down_spec, var_map_additional,
                    ...
                    for goal in routing_goals:
                        if not single_goal_only:
                            if goal.requires_los_check:
                                if target is not None and not target.is_sim:
                                    if (ignore_los_for_vehicle or goal.failure_reason) != GoalFailureType.NoError:
                                        if blocking_obj_id is not None:
                                            if goal.failure_reason == GoalFailureType.LOSBlocked:
                                                ...
                                                continue
                                        if top_level_parent is not target:
                                            ignored_objects = top_level_parent.is_sim or (
                                             top_level_parent,)
                                    else:
                                        ignored_objects = ()
                                    result, blocking_obj_id = target.check_line_of_sight((goal.location.transform),
                                      verbose=True, for_carryable=for_carryable, ignored_objects=ignored_objects)
    ...
    def _generate_right_handles(self, sim, interaction, participant_type, right_path, var_map, destination_spec, final_constraint, unique_id, animation_resolver_fn):
        ...
        if first_spec[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile:
            entry_spec, constrained_edge, _ = first_spec[BODY_INDEX][BODY_TARGET_INDEX] is None or first_spec[BODY_INDEX][BODY_POSTURE_TYPE_INDEX].unconstrained or self.find_entry_posture_spec(sim, right_path, var_map)
 ...
 L.5851         0  BUILD_MAP_0           0 
                2  STORE_FAST               'middle_handles'

 L.5852         4  BUILD_MAP_0           0 
                6  STORE_FAST               'invalid'

 L.5853         8  BUILD_MAP_0           0 
               10  STORE_FAST               'invalid_los'

 L.5855        12  BUILD_LIST_0          0 
               14  STORE_FAST               'blocking_obj_ids'

 L.5860        16  LOAD_FAST                'self'
 ...
 L.5869        70  LOAD_FAST                'self'
               ...
               84  POP_TOP          
               86  JUMP_FORWARD        640  'to 640'
             88_0  COME_FROM            68  '68'
             88_1  COME_FROM            60  '60'

 L.5881        88  LOAD_GLOBAL              PostureGraphMiddlePathError
 ...
 L.5893       100  LOAD_FAST                'destination_spec'
              102  LOAD_FAST                'entry_spec'
              104  LOAD_DEREF               'sim'
              106  LOAD_ATTR                location

 L.5894       108  LOAD_DEREF               'carry_target'
          ...
          126_128  JUMP_FORWARD        640  'to 640'
            130_0  COME_FROM            52  '52'

 L.5899       130  LOAD_FAST                'constrained_edge'
 ...
 L.5901       144  LOAD_DEREF               'carry_target'
              146  LOAD_CONST               None
 ...
 L.5902       158  LOAD_FAST                'animation_resolver_fn'
              160  STORE_DEREF              '_animation_resolver_fn'

 L.5917       162  LOAD_CLOSURE             '_animation_resolver_fn'
 ...
 L.5927       178  LOAD_FAST                'carry_transition_constraint'
              180  LOAD_CONST               None
              182  COMPARE_OP               is-not
          184_186  POP_JUMP_IF_FALSE   360  'to 360'

 L.5928       188  BUILD_LIST_0          0 
              190  STORE_FAST               'carry_transition_constraints'

 L.5929       192  SETUP_LOOP          352  'to 352'
              194  LOAD_FAST                'carry_transition_constraint'
              196  GET_ITER         
              198  FOR_ITER            350  'to 350'
              200  STORE_FAST               'carry_transition_sub_constraint'

 L.5930       202  LOAD_DEREF               'carry_target'
              204  LOAD_CONST               None
              206  COMPARE_OP               is-not
          208_210  POP_JUMP_IF_FALSE   290  'to 290'
              212  LOAD_DEREF               'carry_target'
              214  LOAD_ATTR                is_sim
          216_218  POP_JUMP_IF_FALSE   290  'to 290'

 L.5934       220  LOAD_FAST                'interaction'
 ...
 L.5936       232  LOAD_FAST                'carry_transition_sub_constraint'
              234  LOAD_ATTR                posture_state_spec
              236  LOAD_CONST               None
              238  COMPARE_OP               is-not
          240_242  POP_JUMP_IF_FALSE   290  'to 290'

 L.5937       244  LOAD_FAST                'carry_transition_sub_constraint'
              246  LOAD_ATTR                posture_state_spec
              248  LOAD_ATTR                body_target
              250  STORE_FAST               'carry_body_target'

 L.5938       252  LOAD_FAST                'carry_body_target'
              254  LOAD_CONST               None
              256  COMPARE_OP               is-not
          258_260  POP_JUMP_IF_FALSE   290  'to 290'

 L.5946       262  LOAD_GLOBAL              PostureAspectBody
              ...
              276  STORE_FAST               'body_aspect'

 L.5947       278  LOAD_FAST                'carry_spec'
              280  LOAD_ATTR                clone
              282  LOAD_FAST                'body_aspect'
              284  LOAD_CONST               ('body',)
              286  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              288  STORE_FAST               'carry_spec'
            290_0  COME_FROM           258  '258'
            290_1  COME_FROM           240  '240'
            290_2  COME_FROM           216  '216'
            290_3  COME_FROM           208  '208'

 L.5950       290  LOAD_GLOBAL              postures
              292  LOAD_ATTR                posture_state
              294  LOAD_ATTR                PostureState
              296  LOAD_DEREF               'sim'
              298  LOAD_CONST               None
              300  LOAD_FAST                'carry_spec'

 L.5951       302  LOAD_FAST                'var_map'
              304  LOAD_CONST               True
              306  LOAD_CONST               ('invalid_expected',)
              308  CALL_FUNCTION_KW_5     5  '5 total positional and keyword args'
              310  STORE_FAST               'target_posture_state'

 L.5956       312  LOAD_FAST                'interaction'
              314  LOAD_ATTR                transition
              316  LOAD_METHOD              add_relevant_object
              318  LOAD_FAST                'target_posture_state'
              320  LOAD_ATTR                body_target
              322  CALL_METHOD_1         1  '1 positional argument'
              324  POP_TOP          

 L.5958       326  LOAD_FAST                'carry_transition_sub_constraint'
              328  LOAD_METHOD              apply_posture_state

 L.5959       330  LOAD_FAST                'target_posture_state'
              332  LOAD_FAST                'animation_resolver_fn'
              334  CALL_METHOD_2         2  '2 positional arguments'
              336  STORE_FAST               'carry_transition_sub_constraint'

 L.5960       338  LOAD_FAST                'carry_transition_constraints'
              340  LOAD_METHOD              append
              342  LOAD_FAST                'carry_transition_sub_constraint'
              344  CALL_METHOD_1         1  '1 positional argument'
              346  POP_TOP          
              348  JUMP_BACK           198  'to 198'
              350  POP_BLOCK        
            352_0  COME_FROM_LOOP      192  '192'

 L.5961       352  LOAD_GLOBAL              create_constraint_set
              354  LOAD_FAST                'carry_transition_constraints'
              356  CALL_FUNCTION_1       1  '1 positional argument'
              358  STORE_FAST               'carry_transition_constraint'
            360_0  COME_FROM           184  '184'

 L.5963       360  LOAD_FAST                'carry_transition_constraint'
              362  LOAD_CONST               None
              364  COMPARE_OP               is-not
          366_368  POP_JUMP_IF_FALSE   640  'to 640'

 L.5964       370  LOAD_GLOBAL              any
              372  LOAD_GENEXPR             '<code_object <genexpr>>'
              374  LOAD_STR                 'PostureGraphService._generate_middle_handles.<locals>.<genexpr>'
              376  MAKE_FUNCTION_0          'Neither defaults, keyword-only args, annotations, nor closures'
              378  LOAD_FAST                'carry_transition_constraint'
              380  GET_ITER         
              382  CALL_FUNCTION_1       1  '1 positional argument'
              384  CALL_FUNCTION_1       1  '1 positional argument'
              386  STORE_FAST               'constraint_has_geometry'

 L.5965       388  LOAD_FAST                'constraint_has_geometry'
          390_392  POP_JUMP_IF_TRUE    450  'to 450'

 L.5971       394  LOAD_GLOBAL              services
              396  LOAD_METHOD              current_zone
              398  CALL_METHOD_0         0  '0 positional arguments'
              400  LOAD_ATTR                posture_graph_service
              402  STORE_FAST               'posture_graph_service'

 L.5972       404  LOAD_FAST                'posture_graph_service'
              406  LOAD_METHOD              get_compatible_mobile_posture_target
              408  LOAD_DEREF               'sim'
              410  CALL_METHOD_1         1  '1 positional argument'
              412  STORE_FAST               'posture_object'

 L.5973       414  LOAD_FAST                'posture_object'
              416  LOAD_CONST               None
              418  COMPARE_OP               is-not
          420_422  POP_JUMP_IF_FALSE   450  'to 450'

 L.5974       424  LOAD_FAST                'posture_object'
              426  LOAD_ATTR                get_edge_constraint
              428  LOAD_DEREF               'sim'
              430  LOAD_CONST               ('sim',)
              432  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              434  STORE_FAST               'edge_constraint'

 L.5975       436  LOAD_FAST                'carry_transition_constraint'
              438  LOAD_METHOD              intersect
              440  LOAD_FAST                'edge_constraint'
              442  CALL_METHOD_1         1  '1 positional argument'
              444  STORE_FAST               'carry_transition_constraint'

 L.5976       446  LOAD_CONST               True
              448  STORE_FAST               'constraint_has_geometry'
            450_0  COME_FROM           420  '420'
            450_1  COME_FROM           390  '390'

 L.5980       450  LOAD_FAST                'carry_spec'
              452  LOAD_GLOBAL              SURFACE_INDEX
              454  BINARY_SUBSCR    
              456  STORE_FAST               'carry_spec_surface_spec'

 L.5981       458  LOAD_FAST                'carry_spec_surface_spec'
              460  LOAD_CONST               None
              462  COMPARE_OP               is-not
          464_466  POP_JUMP_IF_FALSE   478  'to 478'

 L.5982       468  LOAD_FAST                'carry_spec_surface_spec'
              470  LOAD_GLOBAL              SURFACE_TARGET_INDEX
              472  BINARY_SUBSCR    
              474  STORE_FAST               'relative_object'
              476  JUMP_FORWARD        482  'to 482'
            478_0  COME_FROM           464  '464'

 L.5984       478  LOAD_CONST               None
              480  STORE_FAST               'relative_object'
            482_0  COME_FROM           476  '476'

 L.5985       482  LOAD_FAST                'relative_object'
              484  LOAD_CONST               None
              486  COMPARE_OP               is
          488_490  POP_JUMP_IF_FALSE   504  'to 504'

 L.5986       492  LOAD_FAST                'carry_spec'
              494  LOAD_GLOBAL              BODY_INDEX
              496  BINARY_SUBSCR    
              498  LOAD_GLOBAL              BODY_TARGET_INDEX
              500  BINARY_SUBSCR    
              502  STORE_FAST               'relative_object'
            504_0  COME_FROM           488  '488'

 L.5987       504  LOAD_FAST                'relative_object'
              506  LOAD_CONST               None
              508  COMPARE_OP               is
          510_512  POP_JUMP_IF_FALSE   548  'to 548'

 L.5988       514  LOAD_FAST                'entry_spec'
              516  LOAD_GLOBAL              CARRY_INDEX
              518  BINARY_SUBSCR    
              520  LOAD_GLOBAL              CARRY_TARGET_INDEX
              522  BINARY_SUBSCR    
              524  STORE_FAST               'relative_object'

 L.5989       526  LOAD_GLOBAL              isinstance
              528  LOAD_FAST                'relative_object'
              530  LOAD_GLOBAL              PostureSpecVariable
              532  CALL_FUNCTION_2       2  '2 positional arguments'
          534_536  POP_JUMP_IF_FALSE   548  'to 548'

 L.5990       538  LOAD_FAST                'var_map'
              540  LOAD_METHOD              get
              542  LOAD_FAST                'relative_object'
              544  CALL_METHOD_1         1  '1 positional argument'
              546  STORE_FAST               'relative_object'
            548_0  COME_FROM           534  '534'
            548_1  COME_FROM           510  '510'

 L.5998       548  LOAD_FAST                'constraint_has_geometry'
          550_552  POP_JUMP_IF_FALSE   624  'to 624'

 L.5999       554  LOAD_FAST                'carry_transition_constraint'
              556  LOAD_METHOD              generate_single_surface_constraints
              558  CALL_METHOD_0         0  '0 positional arguments'
              560  STORE_FAST               'carry_transition_constraint'

 L.6000       562  LOAD_FAST                'self'
              564  LOAD_ATTR                append_handles

 L.6001       566  LOAD_DEREF               'sim'
              568  LOAD_FAST                'middle_handles'
              570  LOAD_FAST                'invalid'
              572  LOAD_FAST                'invalid_los'

 L.6002       574  LOAD_FAST                'carry_transition_constraint'
              576  LOAD_CONST               None
              578  LOAD_FAST                'relative_object'
              580  BUILD_TUPLE_3         3 

 L.6003       582  LOAD_FAST                'middle_path'
              584  LOAD_FAST                'var_map'
              586  LOAD_FAST                'destination_spec'
              588  LOAD_FAST                'unique_id'

 L.6004       590  LOAD_FAST                'final_constraint'
              592  LOAD_GLOBAL              PathType
              594  LOAD_ATTR                MIDDLE_LEFT
              596  LOAD_CONST               ('path_type',)
            598_0  COME_FROM            86  '86'
              598  CALL_FUNCTION_KW_11    11  '11 total positional and keyword args'
              600  STORE_FAST               'blocking_obj_id'

 L.6005       602  LOAD_FAST                'blocking_obj_id'
              604  LOAD_CONST               None
              606  COMPARE_OP               is-not
          608_610  POP_JUMP_IF_FALSE   640  'to 640'

 L.6006       612  LOAD_FAST                'blocking_obj_ids'
              614  LOAD_METHOD              append
              616  LOAD_FAST                'blocking_obj_id'
              618  CALL_METHOD_1         1  '1 positional argument'
              620  POP_TOP          
              622  JUMP_FORWARD        640  'to 640'
            624_0  COME_FROM           550  '550'

 L.6008       624  LOAD_FAST                'self'
              626  LOAD_METHOD              copy_handles
              628  LOAD_DEREF               'sim'
              630  LOAD_FAST                'middle_handles'
              632  LOAD_FAST                'middle_path'
              634  LOAD_FAST                'var_map'
              636  CALL_METHOD_4         4  '4 positional arguments'
              638  POP_TOP          
            640_0  COME_FROM           622  '622'
            640_1  COME_FROM           608  '608'
            640_2  COME_FROM           366  '366'
            640_3  COME_FROM           126  '126'

 L.6009       640  LOAD_FAST                'middle_handles'
              642  LOAD_FAST                'invalid'
              644  LOAD_FAST                'invalid_los'
              646  LOAD_FAST                'blocking_obj_ids'
              648  BUILD_TUPLE_4         4 
              650  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `COME_FROM' instruction at offset 598_0
    ...
    def get_best_path_between_handles(self, interaction, sim, source_destination_sets, timeline, path_type=None):
        ...
        for source_handles, _, _, _, _, _ in source_destination_sets.values():
            for source_handle in source_handles:
                ...
                if interaction.target is not None and source_handle.target is not None:
            ...
            for destination_handle, (right_path, path_cost, var_map, dest_spec, _, _, _) in destination_handles.items():
                ...
                for dest_handle in additional_dest_handles:
                    ...
                    for dest_goal in dest_goals:
                        if middle_path_pickup:
                            if carry_object_at_pool:
                        ...
                        if required_height_clearance > dest_goal.height_clearance:
                            ...
                            dest_is_valid = False
                            continue
                        if not (dest_goal.requires_los_check and dest_handle.target is not None):
                            if dest_handle.target is not None and dest_handle.target.parent is not None:
                                if not dest_handle.target.parent.is_sim:
                                    ignored_objects = (
                                     dest_handle.target.parent,)
                                else:
                                    ignored_objects = ()
        ...
        if not result:
            ...
            if is_failure_path or plan_primitive.path.nodes.plan_success:
                ...
                if isinstance(dest, SlotGoal):
                    selected_dest_containment_transform = dest_path[(-1)][BODY_INDEX][BODY_POSTURE_TYPE_INDEX].mobile or dest.containment_transform
            else:
        ...
        if left_path_spec._path[(-1)].posture_spec != right_path_spec._path[0].posture_spec:
            right_first_spec = TransitionSpec(right_path_spec, (left_path_spec._path[(-1)].posture_spec), (right_path_spec._path[0].var_map),
              portal_obj=(right_path_spec._path[0].portal_obj),
              portal_id=(right_path_spec._path[0].portal_id))

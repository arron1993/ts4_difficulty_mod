...
# Compiled at: 2020-04-15 00:17:36
                        ...
                        if slot_child_is_carryable:
                            if any((included_si.carry_target is slot_child for included_si in included_sis)):
                                ...
                                if any((included_si.target is slot_child for included_si in included_sis)):
                                    ...
                                    logger.error("Interaction {} has a slot_manifest_entry {} with a slot_child {} that doesn't appear to be a carry target or an interaction target. Please grab Tom Astle and show this to him.", interaction,

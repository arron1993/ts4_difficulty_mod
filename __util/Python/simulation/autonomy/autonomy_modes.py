...
# Compiled at: 2020-10-08 00:00:56
# Size of source mod 2**32: 179767 bytes
...
from tag import Tag
import autonomy.autonomy_exceptions, autonomy.autonomy_util, autonomy.settings, clock, date_and_time, element_utils, elements, gsi_handlers, interactions, objects.components.types, services, sims4.log, sims4.random, sims4.reload, sims4.repr_utils, singletons
        ...
        if optimistic:
            ...
            if affordance.ensemble_scoring:
                ...
                if final_score <= self._MINIMUM_SCORE:
                    final_score = 0
                if gsi_commodity_scores is not None:
                    interaction_score = InteractionScore(final_score, interaction, gsi_commodity_scores, efficiency, approximate_duration, autonomy_scoring_preference, rel_utility_score,
                      (self._relationship_object_value), group_utility_score, opportunity_costs=canceled_si_opportunity_costs, must_change_posture=must_change_posture,

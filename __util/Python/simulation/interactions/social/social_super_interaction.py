...
# Compiled at: 2020-07-29 03:59:19
# Size of source mod 2**32: 90646 bytes
...
class SocialSuperInteraction(SocialInteractionMixin, SocialCompatibilityMixin, SuperInteraction):
 ...
 L. 796        16  LOAD_FAST                'participant_type'
 ...
 L. 810       130  SETUP_LOOP          176  'to 176'
 ...
 L. 811       166  LOAD_FAST                'constraint'
              168  YIELD_VALUE      
              170  POP_TOP          
 ...
 L. 860       340  LOAD_CONST               None
              342  RETURN_VALUE     
            344_0  COME_FROM           336  '336'

 L. 862       344  LOAD_FAST                'initiator'
              346  LOAD_CONST               None
 ...
 L. 863       364  LOAD_GLOBAL              get_fallback_social_constraint_position
 ...
 L. 865       382  LOAD_CONST               None
              384  STORE_FAST               'fallback_position'
            386_0  COME_FROM           380  '380'

 L. 867       386  LOAD_FAST                'fallback_position'
              388  LOAD_CONST               None
              390  COMPARE_OP               is
          392_394  POP_JUMP_IF_FALSE   422  'to 422'

 L. 868       396  LOAD_FAST                'inst'
              398  LOAD_CONST               None
              400  COMPARE_OP               is-not
          402_404  POP_JUMP_IF_FALSE   418  'to 418'

 L. 872       406  LOAD_GLOBAL              Constraint
              408  LOAD_CONST               False
              410  LOAD_CONST               ('allow_geometry_intersections',)
              412  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              414  YIELD_VALUE      
              416  POP_TOP          
            418_0  COME_FROM           402  '402'

 L. 873       418  LOAD_CONST               None
              420  RETURN_VALUE     
            422_0  COME_FROM           392  '392'

 L. 875       422  LOAD_FAST                'cls'
              424  LOAD_ATTR                _social_group_type
              426  LOAD_ATTR                make_constraint_default
              428  LOAD_FAST                'initiator'
              430  LOAD_FAST                'recipient'

 L. 876       432  LOAD_FAST                'fallback_position'

 L. 877       434  LOAD_FAST                'fallback_routing_surface'

 L. 878       436  LOAD_FAST                'relative_participant'

 L. 879       438  LOAD_FAST                'picked_object'

 L. 880       440  LOAD_FAST                'inst_or_cls'
              442  LOAD_ATTR                _social_group_participant_slot_overrides
              444  LOAD_CONST               ('participant_type', 'picked_object', 'participant_slot_overrides')
              446  CALL_FUNCTION_KW_7     7  '7 total positional and keyword args'
              448  STORE_FAST               'fallback_constraint'

 L. 882       450  LOAD_FAST                'inst'
              452  LOAD_CONST               None
              454  COMPARE_OP               is-not
          456_458  POP_JUMP_IF_FALSE   466  'to 466'
              460  LOAD_FAST                'inst'
              462  LOAD_ATTR                priority
              464  JUMP_FORWARD        468  'to 468'
            466_0  COME_FROM           456  '456'
              466  LOAD_CONST               None
            468_0  COME_FROM           464  '464'
              468  STORE_FAST               'priority'

 L. 883       470  LOAD_FAST                'sim'
              472  LOAD_ATTR                si_state
              474  LOAD_ATTR                is_compatible_constraint
              476  LOAD_FAST                'fallback_constraint'
              478  LOAD_FAST                'priority'
              480  LOAD_FAST                'inst'
              482  LOAD_CONST               ('priority', 'to_exclude')
              484  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
          486_488  POP_JUMP_IF_FALSE   498  'to 498'

 L. 884       490  LOAD_FAST                'fallback_constraint'
              492  YIELD_VALUE      
              494  POP_TOP          
              496  JUMP_FORWARD        510  'to 510'
            498_0  COME_FROM           486  '486'

 L. 886       498  LOAD_GLOBAL              Constraint
              500  LOAD_CONST               False
              502  LOAD_CONST               ('allow_geometry_intersections',)
              504  CALL_FUNCTION_KW_1     1  '1 total positional and keyword args'
              506  YIELD_VALUE      
              508  POP_TOP          
            510_0  COME_FROM           496  '496'

 L. 887       510  LOAD_CONST               None
              512  RETURN_VALUE     
            514_0  COME_FROM           126  '126'

 L. 889       514  LOAD_FAST                'participant_type'
              516  LOAD_GLOBAL              ParticipantType
              518  LOAD_ATTR                TargetSim
              520  COMPARE_OP               ==
          522_524  POP_JUMP_IF_FALSE   784  'to 784'

 L. 890       526  LOAD_FAST                'cls'
              528  LOAD_ATTR                acquire_targets_as_resource
          530_532  POP_JUMP_IF_TRUE    546  'to 546'

 L. 893       534  LOAD_GLOBAL              Anywhere
              536  CALL_FUNCTION_0       0  '0 positional arguments'
              538  YIELD_VALUE      
              540  POP_TOP          

 L. 894       542  LOAD_CONST               None
              544  RETURN_VALUE     
            546_0  COME_FROM           530  '530'

 L. 898       546  LOAD_FAST                'inst'
              548  LOAD_CONST               None
              550  COMPARE_OP               is-not
          552_554  POP_JUMP_IF_FALSE   668  'to 668'

 L. 899       556  LOAD_FAST                'inst'
 ...
 L. 900       568  LOAD_FAST                'test_result'
          570_572  POP_JUMP_IF_TRUE    592  'to 592'

 L. 901       574  LOAD_GLOBAL              Nowhere
 ...
 L. 902       588  LOAD_CONST               None
              590  RETURN_VALUE     
            592_0  COME_FROM           570  '570'

 L. 904       592  LOAD_FAST                'target_si'
              594  LOAD_CONST               None
              596  COMPARE_OP               is-not
          598_600  POP_JUMP_IF_FALSE   668  'to 668'

 L. 905       602  LOAD_GLOBAL              issubclass
 ...
 L. 910       628  SETUP_LOOP          664  'to 664'
 ...
 L. 911       652  LOAD_FAST                'constraint'
              654  YIELD_VALUE      
              656  POP_TOP          
 ...
 L. 915       704  LOAD_FAST                'constraint'
              706  YIELD_VALUE      
              708  POP_TOP          
 ...
 L. 928       832  LOAD_FAST                'constraint'
              834  YIELD_VALUE      
              836  POP_TOP          

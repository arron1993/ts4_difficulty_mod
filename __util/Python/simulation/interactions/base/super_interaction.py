...
# Compiled at: 2020-10-10 01:51:14
# Size of source mod 2**32: 295886 bytes
...
class SuperInteraction(RouteEventProviderMixin, Interaction, StageControllerElement):
    ...
    @classmethod
    def get_rallyable_aops_gen--- This code section failed: ---

 L.2206         0  LOAD_FAST                'cls'
                2  LOAD_METHOD              _can_rally
                4  LOAD_FAST                'context'
                6  CALL_METHOD_1         1  '1 positional argument'
                8  POP_JUMP_IF_FALSE   216  'to 216'

 L.2207        10  SETUP_LOOP          216  'to 216'
               12  LOAD_FAST                'cls'
               14  LOAD_ATTR                rallyable
               16  GET_ITER         
               18  FOR_ITER            214  'to 214'
               20  STORE_FAST               'entry'

 L.2208        22  LOAD_CONST               0
               24  LOAD_CONST               ('RallyInteraction',)
               26  IMPORT_NAME_ATTR         interactions.base.rally_interaction
               28  IMPORT_FROM              RallyInteraction
               30  STORE_FAST               'RallyInteraction'
               32  POP_TOP          

 L.2209        34  LOAD_FAST                'affordance'
               36  LOAD_CONST               None
               38  COMPARE_OP               is-not
               40  POP_JUMP_IF_FALSE    46  'to 46'
               42  LOAD_FAST                'affordance'
               44  JUMP_FORWARD         48  'to 48'
             46_0  COME_FROM            40  '40'
               46  LOAD_FAST                'cls'
             48_0  COME_FROM            44  '44'
               48  STORE_FAST               'affordance'

 L.2210        50  LOAD_FAST                'RallyInteraction'
               52  LOAD_ATTR                generate
               54  LOAD_FAST                'affordance'
               56  LOAD_FAST                'entry'
               58  LOAD_ATTR                tag
               60  LOAD_CONST               0

 L.2211        62  LOAD_FAST                'entry'
               64  LOAD_ATTR                behavior

 L.2212        66  LOAD_FAST                'entry'
               68  LOAD_ATTR                push_social

 L.2213        70  LOAD_FAST                'rally_constraint'

 L.2214        72  LOAD_FAST                'entry'
               74  LOAD_ATTR                sources

 L.2215        76  LOAD_FAST                'entry'
               78  LOAD_ATTR                pie_menu_icon

 L.2216        80  LOAD_FAST                'entry'
               82  LOAD_ATTR                rally_allow_forward
               84  LOAD_CONST               ('rally_tag', 'rally_level', 'rally_data', 'rally_push_social', 'rally_constraint', 'rally_sources', 'rally_pie_menu_icon', 'rally_allow_forward')
               86  CALL_FUNCTION_KW_9     9  '9 total positional and keyword args'
               88  STORE_FAST               'rally_interaction'

 L.2218        90  SETUP_LOOP          212  'to 212'
               92  LOAD_FAST                'rally_interaction'
               94  LOAD_ATTR                potential_interactions
               96  LOAD_FAST                'target'
            ...
            108_0  COME_FROM           132  '132'
              108  FOR_ITER            210  'to 210'
              110  STORE_FAST               'aop'

 L.2223       112  LOAD_FAST                'context'
              114  LOAD_ATTR                sim
              116  STORE_FAST               'initiating_sim'

 L.2228       118  LOAD_FAST                'initiating_sim'
              120  LOAD_METHOD              get_sims_for_rally
              122  LOAD_FAST                'entry'
              124  LOAD_ATTR                sources
              126  CALL_METHOD_1         1  '1 positional argument'
              128  STORE_FAST               'rally_sims'

 L.2229       130  LOAD_FAST                'rally_sims'
              132  POP_JUMP_IF_FALSE   108  'to 108'

 L.2230       134  LOAD_FAST                'entry'
              136  LOAD_ATTR                skip_interaction_test
              138  POP_JUMP_IF_FALSE   148  'to 148'

 L.2231       140  LOAD_FAST                'aop'
              142  YIELD_VALUE      
              144  POP_TOP          
              146  JUMP_BACK           108  'to 108'
            148_0  COME_FROM           138  '138'

 L.2233       148  SETUP_LOOP          208  'to 208'
              150  LOAD_FAST                'rally_sims'
              152  GET_ITER         
            154_0  COME_FROM           194  '194'
            154_1  COME_FROM           164  '164'
              154  FOR_ITER            200  'to 200'
              156  STORE_FAST               'sim'

 L.2234       158  LOAD_FAST                'initiating_sim'
              160  LOAD_FAST                'sim'
              162  COMPARE_OP               is-not
              164  POP_JUMP_IF_FALSE   154  'to 154'

 L.2235       166  LOAD_FAST                'context'
              168  LOAD_METHOD              clone_for_sim
              170  LOAD_FAST                'sim'
              172  CALL_METHOD_1         1  '1 positional argument'
              174  STORE_FAST               'group_member_context'

 L.2236       176  LOAD_GLOBAL              ChoiceMenu
              178  LOAD_ATTR                is_valid_aop
              180  LOAD_FAST                'aop'
              182  LOAD_FAST                'group_member_context'
              184  LOAD_FAST                'target'
              186  LOAD_CONST               ('user_pick_target',)
              188  CALL_FUNCTION_KW_3     3  '3 total positional and keyword args'
              190  STORE_FAST               'result'

 L.2237       192  LOAD_FAST                'result'
              194  POP_JUMP_IF_TRUE    154  'to 154'

 L.2238       196  BREAK_LOOP       
              198  JUMP_BACK           154  'to 154'
              200  POP_BLOCK        

 L.2240       202  LOAD_FAST                'aop'
              204  YIELD_VALUE      
              206  POP_TOP          
            208_0  COME_FROM_LOOP      148  '148'
              208  JUMP_BACK           108  'to 108'
              210  POP_BLOCK        
            212_0  COME_FROM_LOOP       90  '90'
              212  JUMP_BACK            18  'to 18'
              214  POP_BLOCK        
            216_0  COME_FROM_LOOP       10  '10'
            216_1  COME_FROM             8  '8'
    ...
    def provide_route_events(self, route_event_context, sim, path, failed_types=None, **kwargs):
        ...
        for route_event_tuple in self.route_events:
            ...
            for participant in participants:
                if not participant is sim or failed_types is None or route_event_tuple.route_event not in failed_types:
                    if route_event_context.route_event_already_scheduled(route_event_tuple.route_event) or route_event_tuple.route_event is not None and route_event_tuple.route_event.test(resolver):
...
True # Avoid dead code: False
        ...
        for on_cancel_aop, context, posture in on_cancel_aops_contexts_postures:
            if on_cancel_aop.affordance is None:
                ...
                if not sim.queue.needs_cancel_aop(on_cancel_aop, context):
                    continue
                if posture.has_linked_sim_pushed_cancel(carry_cancel_override=carry_cancel_override):
                    continue
 ...
 L.5458        30  BUILD_MAP_0           0 
               32  RETURN_VALUE     
             34_0  COME_FROM            28  '28'

 L.5460        34  LOAD_FAST                'skill_stat'
               36  LOAD_DEREF               'self'
 ...
 L.5461        48  LOAD_FAST                'tested_result'
               50  LOAD_CONST               None
               52  COMPARE_OP               is
               54  POP_JUMP_IF_FALSE    60  'to 60'

 L.5462        56  BUILD_MAP_0           0 
               58  RETURN_VALUE     
             60_0  COME_FROM            54  '54'

 L.5464        60  LOAD_FAST                'skill_sim'
 ...
 L.5465        70  LOAD_FAST                'animation_stat'
               72  LOAD_CONST               None
               74  COMPARE_OP               is-not
               76  POP_JUMP_IF_FALSE   120  'to 120'

 L.5466        78  LOAD_FAST                'animation_stat'
 ...
 L.5467        90  LOAD_FAST                'asm_param_name'
               92  LOAD_CONST               None
 ...
 L.5468       106  LOAD_FAST                'asm_param_name'
 ...
 L.5473       152  LOAD_FAST                'asm_param_name'
              154  LOAD_CONST               None
 ...
 L.5474       168  LOAD_FAST                'asm_param_name'
...
Parse error at or near `RETURN_VALUE' instruction at offset 182
 ...
 L.5496        30  LOAD_CONST               None
               32  RETURN_VALUE     
             34_0  COME_FROM            28  '28'

 L.5498        34  LOAD_FAST                'skill_stat'
               36  LOAD_DEREF               'self'
               38  LOAD_METHOD              get_resolver
               40  CALL_METHOD_0         0  '0 positional arguments'
               42  LOAD_CONST               ('resolver',)
 ...
 L.5499        48  LOAD_FAST                'tested_result'
               50  LOAD_CONST               None
               52  COMPARE_OP               is
               54  POP_JUMP_IF_FALSE    60  'to 60'

 L.5500        56  LOAD_CONST               None
               58  RETURN_VALUE     
             60_0  COME_FROM            54  '54'

 L.5502        60  LOAD_FAST                'skill_sim'
 ...
 L.5503        74  LOAD_FAST                'animation_stat'
               76  LOAD_CONST               None
               78  COMPARE_OP               is-not
               80  POP_JUMP_IF_FALSE   126  'to 126'

 L.5504        82  LOAD_FAST                'animation_stat'
 ...
 L.5505        94  LOAD_FAST                'asm_param_name'
               96  LOAD_CONST               None
...
Parse error at or near `COME_FROM' instruction at offset 126_1
 ...
 L.5525         0  LOAD_FAST                'walkstyle_sim'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_TRUE     30  'to 30'
 ...
 L.5527        30  LOAD_CONST               None
               32  RETURN_VALUE     
             34_0  COME_FROM            28  '28'

 L.5529        34  LOAD_FAST                'walkstyle'

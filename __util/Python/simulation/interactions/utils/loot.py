...
# Size of source mod 2**32: 36233 bytes
...
from crafting.crafting_loots import RefundCraftingProcessLoot
...
from drama_scheduler.festival_contest_ops import FestivalContestAwardWinners
...
from objects.components.utils.register_to_lost_and_found_op import RegisterToLostAndFoundOp
...
from relationships.relationship_knowledge_ops import KnowOtherSimTraitOp, KnowOtherSimCareerOp, KnowOtherSimsStat, KnowOtherSimMajorOp
...
class LootActionVariant(TunableVariant):
 ...
 'default_participant':ParticipantType.Object}), 
         ...
         register_to_lost_and_found=RegisterToLostAndFoundOp.TunableFactory(), 
         set_routing_info_and_state=SetRoutingInfoAndStateOp.TunableFactory(), 
         add_career_gig=AddCareerGigOp.TunableFactory(), 
         force_spawn_objects=ForceSpawnObjects.TunableFactory(), **kwargs)
...
class LootActions(HasTunableReference, HasTunableSingletonFactory, AutoFactoryInit, metaclass=TunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.ACTION)):
 ...
 L. 435        30  LOAD_FAST                'inst_or_cls'
               32  LOAD_ATTR                tests
 ...
 L. 439        60  SETUP_LOOP          244  'to 244'
 ...
 L. 445       128  BUILD_LIST_0          0 
              130  STORE_FAST               'actions_that_can_be_applied'

 L. 446       132  SETUP_LOOP          180  'to 180'
 ...
 L. 448       166  LOAD_FAST                'actions_that_can_be_applied'

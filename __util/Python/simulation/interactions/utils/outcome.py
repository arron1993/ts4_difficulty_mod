...
# Compiled at: 2020-08-08 01:17:37
# Size of source mod 2**32: 86505 bytes
import random
...
class InteractionOutcomeTestBased(InteractionOutcome):
    ...
    def _set_debug_outcome(self, debug_outcome_index, resolver):
        ...
        if self._fallback_outcomes:
            if debug_outcome_index <= len(self._fallback_outcomes):
                return (
...
class TunableOutcomeTestBased(TunableSingletonFactory):
    ...
    def __init__(self, outcome_action_kwargs=None, **kwargs):
        ...
        super().__init__(description='\n            Based on the tests and the weights of the outcomes, a\n            single outcome will be selected.\n            ',
          ...
          potential_outcomes=(TunableList(TunableTuple(description='\n                    List of weight/outcome pairs.\n                    ',
...
class InteractionOutcomePartial(InteractionOutcome):
 ...
 L.1063         0  LOAD_FAST                'self'
                2  LOAD_ATTR                _default_actions
                4  LOAD_FAST                'self'
                6  STORE_ATTR               _actions

 L.1065         8  LOAD_FAST                'interaction'
 ...
 L.1084       188  LOAD_FAST                'valid_sim_ids'
              190  LOAD_METHOD              add
              192  LOAD_FAST                'sim'
              194  LOAD_ATTR                id
 ...
 L.1089       234  BUILD_LIST_0          0 
              236  STORE_FAST               'bullet_points'

 L.1090       238  SETUP_LOOP          298  'to 298'
              240  LOAD_FAST                'picked_sims'
              242  GET_ITER         
              244  FOR_ITER            296  'to 296'
              246  STORE_FAST               'sim'

 L.1091       248  LOAD_FAST                'self'
 ...
 L.1092       264  LOAD_FAST                'return_val'
          266_268  POP_JUMP_IF_TRUE    282  'to 282'

 L.1093       270  LOAD_FAST                'bullet_points'
 ...
 L.1095       282  LOAD_FAST                'valid_sim_ids'
              284  LOAD_METHOD              add
              286  LOAD_FAST                'sim'
              288  LOAD_ATTR                id
 ...
 L.1105       390  LOAD_GLOBAL              LocalizationHelperTuning
 ...
 L.1129       634  LOAD_FAST                'interaction'

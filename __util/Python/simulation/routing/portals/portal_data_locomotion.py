...
# Compiled at: 2020-08-13 18:29:53
# Size of source mod 2**32: 9585 bytes
...
import routing, services, sims4, terrain
...
class _PortalTypeDataLocomotion(_PortalTypeDataBase):
    ...
    def get_portal_locations(self, obj):
        ...
        for portal_entry in self.object_portals:
            ...
            if self._is_offset_from_object(there_entry, obj) or self._is_offset_from_object(there_exit, obj):
                continue

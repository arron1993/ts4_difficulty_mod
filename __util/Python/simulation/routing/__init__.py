...
# Compiled at: 2020-10-20 18:37:53
# Size of source mod 2**32: 45100 bytes
...
class Path:
    ...
    def get_location_data_along_segment_gen(self, first_node_index, last_node_index, time_step=0.3):
        if self.nodes is None:
            return

...
# Compiled at: 2018-08-09 00:29:18
        ...
        for sim_info in sim_info_manager.objects:
            if sim_info.sim_id == sim_id:
                ...
                for whim, source_whimset in whim_tracker.whims_and_parents_gen():
                    whim_data = {'sim_id':str(sim_info.sim_id), 
                     'whim':whim.get_gsi_name(), 
                     'instance':whim.__class__.__name__, 
                     'whimset':source_whimset.__name__, 
                     'target':str(whim_tracker.get_whimset_target(source_whimset)), 
                     'value':whim.score}
            ...
            if sim_info.sim_id == sim_id:
                ...
                for whimset in active_sets:
                    set_data = {'sim_id':str(sim_info.sim_id), 
                     ...
                     'target':str(whim_tracker.get_whimset_target(whimset))}
                    sub_data = []

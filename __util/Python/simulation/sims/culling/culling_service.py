...
class CullingService(Service):
 ...
 L.  63        14  BUILD_MAP_0           0 
               16  LOAD_FAST                'self'
               18  STORE_ATTR               _interacting_sims

 L.  64        20  LOAD_GLOBAL              services
 ...
 L.  65        32  LOAD_FAST                'save_slot_data_msg'
               34  LOAD_CONST               None
               36  COMPARE_OP               is
 ...
 L.  66        50  LOAD_FAST                'save_slot_data_msg'
 ...
 L.  70        86  LOAD_GLOBAL              DateAndTime

...
# Compiled at: 2020-10-20 19:43:42
# Size of source mod 2**32: 28566 bytes
...
class OutfitTrackerMixin:
 ...
 L. 386        12  LOAD_FAST                'sim'
               14  LOAD_CONST               None
               16  COMPARE_OP               is
               18  POP_JUMP_IF_FALSE    24  'to 24'

 L. 387        20  LOAD_FAST                'outfit_change'
               22  RETURN_VALUE     
             24_0  COME_FROM            18  '18'

 L. 390        24  LOAD_FAST                'self'
 ...
 L. 391        44  LOAD_FAST                'outfit_change'
               46  RETURN_VALUE     
             48_0  COME_FROM            42  '42'
             48_1  COME_FROM            32  '32'

 L. 393        48  LOAD_FAST                'outfit_change'
               50  LOAD_CONST               0
               52  BINARY_SUBSCR    
 ...
 L. 404       130  LOAD_FAST                'career'
              132  LOAD_METHOD              generate_outfit
              134  CALL_METHOD_0         0  '0 positional arguments'
              136  POP_TOP          

 L. 406       138  LOAD_GLOBAL              OutfitCategory
              140  LOAD_ATTR                CAREER
              142  LOAD_CONST               0
              144  BUILD_TUPLE_2         2 
              146  STORE_FAST               'career_outfit_change'

 L. 407       148  LOAD_FAST                'career_outfit_change'
              150  RETURN_VALUE     
            152_0  COME_FROM           102  '102'

 L. 409       152  LOAD_FAST                'outfit_change'
              154  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RETURN_VALUE' instruction at offset 154
    ...
    def has_cas_part(self, cas_part):
        try:
            ...
            try:
                logger.exception('Exception encountered trying to get the current outfit: ', exc=exception,

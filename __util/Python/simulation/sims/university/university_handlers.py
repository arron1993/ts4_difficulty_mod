...
# Compiled at: 2019-10-17 19:25:34
# Size of source mod 2**32: 10601 bytes
    ...
    for university_id, degree_ids in not_yet_accepted_degrees.items():
        ...
        for degree_id in degree_ids:
            ...
            degrees_data.append({'degree':degree.__name__, 
             ...
             'sim_score':str(degree.get_sim_acceptance_score(sim_info)) if is_prestige else '', 
             'is_qualify':degree.can_sim_be_accepted(sim_info) if is_prestige else True})

...
# Compiled at: 2020-10-19 20:56:19
# Size of source mod 2**32: 143575 bytes
...
class DegreeTracker(SimInfoTracker):
 ...
 L. 927        34  LOAD_FAST                'course_info'
               36  LOAD_FAST                'careers'
               38  COMPARE_OP               in
               40  POP_JUMP_IF_FALSE    30  'to 30'

 L. 928        42  LOAD_FAST                'active_course_slots'
 ...
 L. 931        86  LOAD_FAST                'active_course_slots'
               88  RETURN_VALUE     
               -1  RETURN_LAST      
        ...
        for university in University.ALL_UNIVERSITIES:
            for degree in University.ALL_DEGREES:
                if self.is_accepted_degree(university, degree):
                    continue
                if degree in university.prestige_degrees:

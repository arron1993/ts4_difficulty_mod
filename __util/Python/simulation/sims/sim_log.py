...
# Compiled at: 2020-05-06 19:15:48
# Size of source mod 2**32: 14882 bytes
...
def create_tested_outcome_message(selected_outcome, weights):
    selected_outcome_part = '-------- Selected Outcome: -----\n' + str(selected_outcome).replace(',', '\n')
    weight_part = '------- Weights: ------\n' + '\n\n'.join(map(str, weights))
    return selected_outcome_part + '\n\n' + weight_part

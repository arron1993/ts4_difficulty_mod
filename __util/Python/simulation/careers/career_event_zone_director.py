...
# Compiled at: 2018-09-12 22:41:07
...
class CareerEventZoneDirector(SchedulingZoneDirector):
    ...
    def _decide_whether_to_load_zone_situation_seed(self, seed):
        if not super()._decide_whether_to_load_zone_situation_seed(seed):
            return False
        if seed.situation_id == self._career_event.get_event_situation_id() or seed.situation_id in self._situation_ids or seed.situation_id in self._background_situation_ids:
            return True
        return False

...
# Compiled at: 2020-10-22 02:51:12
# Size of source mod 2**32: 29172 bytes
import random
...
class CareerTone(AwayAction):
    ...
    def _update(self):
        ...
        if career is None:
            ...
            return
        if career._upcoming_gig is not None:
            if career._upcoming_gig.odd_job_tuning is not None:
                return

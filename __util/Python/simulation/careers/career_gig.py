...
# Compiled at: 2020-09-29 22:16:50
# Size of source mod 2**32: 54130 bytes
...
class Gig(HasTunableReference, _GigDisplayMixin, PrepTaskTrackerMixin, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.CAREER_GIG)):
    ...
    def get_pay(self, overmax_level=0, **kwargs):
    ...
    @flexmethod
    def build_gig_msg(cls, inst, msg, sim, gig_time=None, gig_customer=None):

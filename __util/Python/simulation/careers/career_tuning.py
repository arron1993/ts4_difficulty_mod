...
# Compiled at: 2020-09-21 22:07:22
# Size of source mod 2**32: 114380 bytes
...
class Career(HasTunableReference, careers.career_base.CareerBase, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.CAREER)):
    ...
    INSTANCE_TUNABLES = {'career_category':TunableEnumEntry(description='\n            Category for career, this will be used for aspirations and other\n            systems which should trigger for careers categories but not for\n            others.\n            ',
     ...
     'tested_affordances':TunableList(description="\n            A list of test sets to run to choose the affordance to go work. If \n            an affordance is found from this list, it will be pushed onto the \n            Sim.\n            \n            If no affordance is found from this list that pass the tests, \n            normal work affordance behavior will take over, running \n            'career_affordance' if at home or 'go_home_to_work_affordance' if \n            not at home.\n            ",
       ...
       manager=(services.get_instance_manager(sims4.resources.Types.INTERACTION))))), 
     'levels_lost_on_leave':sims4.tuning.tunable.Tunable(int, 1, description='When you leave this career for any reason you will immediately lose this many levels, for rejoining the career. i.e. if you quit your job at level 8, and then rejoined with this value set to 1, you would rejoin the career at level 7.'), 
     'days_to_level_loss':sims4.tuning.tunable.Tunable(int, 1, description='When you leave a career, we store off the level youwould rejoin the career at. Every days_to_level_loss days you will lose another level. i.e. I quit my job at level 8. I get reducedlevel 7 right away because of levels_lost_on_leave. Then with days_to_level_loss set to 3, in 3 days I would goto level 6, in 6 days level 5, etc...'), 
     ...
     'career_messages':TunableTuple(join_career_notification=OptionalTunable(description='\n                If tuned, we will show a message when a sim joins this career.\n                If not tuned, no message will be shown.\n                ',
       ...
       locked_args={'no_notification': None}),
       tuning_group=GroupNames.UI), 
     'can_be_fired':sims4.tuning.tunable.Tunable(bool, True, description='Whether or not the Sim can be fired from this career.  For example, children cannot be fired from school.'), 
 ...
 L.1226         0  LOAD_CONST               0
                2  STORE_FAST               'max_user_level'

 L.1227         4  LOAD_FAST                'cls'
 ...
 L.1229        16  SETUP_LOOP          100  'to 100'
               18  LOAD_FAST                'stack'
               20  POP_JUMP_IF_FALSE    98  'to 98'

 L.1230        22  LOAD_FAST                'stack'
               24  LOAD_METHOD              pop
 ...
 L.1233        48  LOAD_FAST                'track'
               50  LOAD_ATTR                branches
               52  POP_JUMP_IF_FALSE    86  'to 86'

 L.1234        54  SETUP_LOOP           96  'to 96'
               56  LOAD_FAST                'track'
 ...
 L.1239       100  LOAD_FAST                'max_user_level'
              102  RETURN_VALUE     
               -1  RETURN_LAST      
        ...
        for career_tuning in all_possible_careers:
            ...
            if test_result:
                if sim_info.career_tracker.get_career_by_uid(career_tuning.guid64) is None:
                    new_level, _, current_track = career_tuning.get_career_entry_level(career_history=(sim_info.career_tracker.career_history),
                      resolver=(SingleSimResolver(sim_info)))
...
class CareerSelectElement(interactions.utils.interaction_elements.XevtTriggeredElement):
 ...
 L.2281        12  LOAD_CONST               None
               14  RETURN_VALUE     
             16_0  COME_FROM            10  '10'

 L.2283        16  LOAD_FAST                'self'
 ...
 L.2285        30  LOAD_FAST                'participants'
               32  LOAD_CONST               None
               34  COMPARE_OP               is
 ...
 L.2287        72  LOAD_CONST               None
               74  RETURN_VALUE     
             76_0  COME_FROM            48  '48'

 L.2289        76  LOAD_GLOBAL              len
 ...
 L.2293       122  LOAD_GLOBAL              getattr
 ...
 L.2296       148  LOAD_GLOBAL              Career
              150  LOAD_ATTR                NUM_CAREERS_PER_DAY
              152  STORE_FAST               'num'

 L.2297       154  LOAD_FAST                'self'
 ...
 L.2298       170  LOAD_CONST               0
              172  STORE_FAST               'num'
            174_0  COME_FROM           168  '168'

 L.2300       174  LOAD_DEREF               'sim_info'
 ...
 L.2302       194  LOAD_GLOBAL              Career
              196  LOAD_ATTR                get_join_career_pb
              198  LOAD_DEREF               'sim_info'

 L.2303       200  LOAD_FAST                'num'

 L.2304       202  LOAD_FAST                'default_career_selection_data'
 ...
 L.2305       210  LOAD_GLOBAL              Distributor
 ...
 L.2307       254  LOAD_GLOBAL              len
              ...
              266  LOAD_CONST               1
              268  COMPARE_OP               ==
          270_272  POP_JUMP_IF_FALSE   440  'to 440'

 L.2311       274  LOAD_CLOSURE             'career'
 ...
 L.2315       288  SETUP_LOOP          490  'to 490'
              290  LOAD_DEREF               'sim_info'
              292  LOAD_ATTR                career_tracker
              294  LOAD_METHOD              get_quittable_careers
              296  CALL_METHOD_0         0  '0 positional arguments'
              298  LOAD_METHOD              values
              300  CALL_METHOD_0         0  '0 positional arguments'
              302  GET_ITER         
              304  FOR_ITER            436  'to 436'
              306  STORE_DEREF              'career'

 L.2318       308  LOAD_DEREF               'career'
              310  LOAD_ATTR                _current_track
              312  LOAD_METHOD              get_career_name
              314  LOAD_DEREF               'sim_info'
              316  CALL_METHOD_1         1  '1 positional argument'
              318  STORE_FAST               'career_name'

 L.2319       320  LOAD_DEREF               'career'
              322  LOAD_ATTR                current_level_tuning
              324  LOAD_METHOD              get_title
              326  LOAD_DEREF               'sim_info'
              328  CALL_METHOD_1         1  '1 positional argument'
              330  STORE_FAST               'job_title'

 L.2320       332  LOAD_CONST               None
              334  STORE_FAST               'dialog'

 L.2321       336  LOAD_GLOBAL              SingleSimResolver
              338  LOAD_DEREF               'sim_info'
              340  CALL_FUNCTION_1       1  '1 positional argument'
              342  STORE_FAST               'resolver'

 L.2322       344  LOAD_DEREF               'career'
 ...
 L.2323       358  LOAD_DEREF               'career'
              360  LOAD_ATTR                quittable_data
              362  LOAD_ATTR                tested_quit_dialog
              364  LOAD_ATTR                test_set
              366  LOAD_METHOD              run_tests
              368  LOAD_FAST                'resolver'
              370  CALL_METHOD_1         1  '1 positional argument'
          372_374  POP_JUMP_IF_FALSE   394  'to 394'

 L.2324       376  LOAD_DEREF               'career'
              378  LOAD_ATTR                quittable_data
              380  LOAD_ATTR                tested_quit_dialog
              382  LOAD_METHOD              quit_dialog
              384  LOAD_DEREF               'sim_info'
              386  LOAD_FAST                'resolver'
              388  CALL_METHOD_2         2  '2 positional arguments'
              390  STORE_FAST               'dialog'
              392  JUMP_FORWARD        408  'to 408'
            394_0  COME_FROM           372  '372'
            394_1  COME_FROM           354  '354'

 L.2326       394  LOAD_DEREF               'career'
              396  LOAD_ATTR                quittable_data
              398  LOAD_METHOD              quit_dialog
              400  LOAD_DEREF               'sim_info'
              402  LOAD_FAST                'resolver'
              404  CALL_METHOD_2         2  '2 positional arguments'
              406  STORE_FAST               'dialog'
            408_0  COME_FROM           392  '392'

 L.2328       408  LOAD_FAST                'dialog'
              410  LOAD_ATTR                show_dialog
              412  LOAD_FAST                'on_quit_dialog_response'

 L.2329       414  LOAD_FAST                'career_name'
              416  LOAD_FAST                'job_title'
              418  LOAD_DEREF               'career'
              420  LOAD_METHOD              get_company_name
              422  CALL_METHOD_0         0  '0 positional arguments'
              424  BUILD_TUPLE_3         3 
              426  LOAD_CONST               ('on_response', 'additional_tokens')
              428  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              430  POP_TOP          
          432_434  JUMP_BACK           304  'to 304'
              436  POP_BLOCK        
              438  JUMP_FORWARD        490  'to 490'
            440_0  COME_FROM           270  '270'

 L.2331       440  LOAD_DEREF               'sim_info'
              442  LOAD_ATTR                is_selectable
          444_446  POP_JUMP_IF_FALSE   544  'to 544'
              448  LOAD_DEREF               'sim_info'
              450  LOAD_ATTR                valid_for_distribution
          452_454  POP_JUMP_IF_FALSE   544  'to 544'

 L.2332       456  LOAD_GLOBAL              Career
              458  LOAD_METHOD              get_quit_career_pb
              460  LOAD_DEREF               'sim_info'
              462  CALL_METHOD_1         1  '1 positional argument'
              464  STORE_FAST               'msg'

 L.2333       466  LOAD_GLOBAL              Distributor
              468  LOAD_METHOD              instance
              470  CALL_METHOD_0         0  '0 positional arguments'
              472  LOAD_METHOD              add_op
              474  LOAD_DEREF               'sim_info'
              476  LOAD_GLOBAL              GenericProtocolBufferOp
              478  LOAD_GLOBAL              Operation
              480  LOAD_ATTR                SELECT_CAREER_UI
              482  LOAD_FAST                'msg'
              484  CALL_FUNCTION_2       2  '2 positional arguments'
              486  CALL_METHOD_2         2  '2 positional arguments'
              488  POP_TOP          
            490_0  COME_FROM           438  '438'
            490_1  COME_FROM_LOOP      288  '288'
              490  JUMP_FORWARD        544  'to 544'
            492_0  COME_FROM           250  '250'

 L.2334       492  LOAD_FAST                'self'
              494  LOAD_ATTR                career_op
              496  LOAD_GLOBAL              career_ops
              498  LOAD_ATTR                CareerOps
              500  LOAD_ATTR                CALLED_IN_SICK
              502  COMPARE_OP               ==
          504_506  POP_JUMP_IF_FALSE   544  'to 544'

 L.2335       508  SETUP_LOOP          544  'to 544'
              510  LOAD_DEREF               'sim_info'
              512  LOAD_ATTR                careers
              514  LOAD_METHOD              values
              516  CALL_METHOD_0         0  '0 positional arguments'
              518  GET_ITER         
              520  FOR_ITER            542  'to 542'
              522  STORE_DEREF              'career'

 L.2336       524  LOAD_DEREF               'career'
              526  LOAD_METHOD              request_day_off
              528  LOAD_GLOBAL              career_ops
              530  LOAD_ATTR                CareerTimeOffReason
              532  LOAD_ATTR                FAKE_SICK
              534  CALL_METHOD_1         1  '1 positional argument'
              536  POP_TOP          
          538_540  JUMP_BACK           520  'to 520'
              542  POP_BLOCK        
            544_0  COME_FROM_LOOP      508  '508'
            544_1  COME_FROM           504  '504'
            544_2  COME_FROM           490  '490'
            544_3  COME_FROM           452  '452'
            544_4  COME_FROM           444  '444'
            544_5  COME_FROM           234  '234'

Parse error at or near `COME_FROM_LOOP' instruction at offset 490_1
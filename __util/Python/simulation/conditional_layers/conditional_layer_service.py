...
# Compiled at: 2020-04-30 23:51:44
# Size of source mod 2**32: 49025 bytes
...
import alarms, enum, objects.components.types, persistence_error_types, services, sims4.log, world.street
...
class ConditionalLayerService(Service):
    ...
    def load_tested_conditional_layers(self, editmode=False):
        ...
        if street_cls:
            if street_cls.tested_conditional_layers:
    ...
    def destroy_street_layer(self, layer_to_destroy, speed):
        ...
        self.destroy_conditional_layer(layer_to_destroy, speed=speed,
          timer_interval=(self.STREET_LAYER_OBJECTS_ALARM_TIME),
          timer_object_count=(self.STREET_LAYER_OBJECTS_TO_DESTROY))
    ...
    def load_street_layer(self, layer_to_load, speed):
        ...
        self.load_conditional_layer(layer_to_load, speed=speed,
          timer_interval=(self.STREET_LAYER_OBJECTS_ALARM_TIME),
          timer_object_count=(self.STREET_LAYER_OBJECTS_TO_DESTROY))
    ...
    def load_street_layers(self, street_cls, editmode=False):
        ...
        for tested_conditional_layer in street_cls.tested_conditional_layers:
            if editmode:
                if not tested_conditional_layer.test_on_managed_world_edit_mode_load:
                    continue
            else:

...
# Embedded file name: T:\InGame\Gameplay\Scripts\Server\story_progression\story_progression_demographic.py
# Compiled at: 2017-06-13 23:46:23
...
class _StoryProgressionDemographicWithFilter(_StoryProgressionDemographic):
    ...
    def _is_valid_agent(self, sim_info_agent):
        ...
        return services.sim_filter_service().does_sim_match_filter((sim_info_agent.sim_id), sim_filter=(self.population_filter),
...
class StoryProgressionDemographicEmployment(_StoryProgressionDemographicWithFilter):
    ...
    def get_demographic_error(self):
        ...
        if employment_ratio > self.employment_rate.upper_bound:
...
class TunableStoryProgressionDemographicVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        (super().__init__)(args, employment=StoryProgressionDemographicEmployment.TunableFactory(), 
         default='employment', **kwargs)
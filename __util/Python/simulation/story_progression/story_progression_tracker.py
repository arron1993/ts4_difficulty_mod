...
# Compiled at: 2016-08-08 19:42:37
...
import gsi_handlers.story_progression_handlers, services, sims4.resources
...
class StoryProgressionTracker(SimInfoTracker):
    ...
    def _get_combined_score(self, story_progression_action, global_demographics):
        ...
        return score and global_demographics or (
         score, global_demographics)
        ...
        return (
         score + average_demographic_score, action_demographics)

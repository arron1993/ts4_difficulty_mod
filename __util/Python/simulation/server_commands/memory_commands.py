...
# Compiled at: 2020-06-09 01:43:28
# Size of source mod 2**32: 25093 bytes
import collections, gc, os, sys, time
from sims4.commands import CommandType
from sims4.utils import create_csv
import alarms, clock, game_services, services, sims4.commands, sims4.core_services, sims4.gsi.archive, sims4.reload, sizeof
...
def garbage_collector_dump--- This code section failed: ---
 ...
 L. 228        42  LOAD_GLOBAL              populate_all_referants
               44  LOAD_FAST                'obj'
 ...
 L. 230        56  LOAD_CONST               0
               58  STORE_FAST               'index'

 L. 231        60  LOAD_STR                 'python_mem_dump.txt'
               62  STORE_FAST               'file_name'

 L. 232        64  SETUP_LOOP          100  'to 100'
               66  LOAD_GLOBAL              os
               68  LOAD_ATTR                path
 ...
 L. 233        78  LOAD_FAST                'index'
               80  LOAD_CONST               1
               82  INPLACE_ADD      
               84  STORE_FAST               'index'

 L. 234        86  LOAD_STR                 'python_mem_dump{}.txt'
 ...
 L. 240       150  LOAD_FAST                'cur_index'
              152  LOAD_CONST               1
              154  INPLACE_ADD      
              156  STORE_FAST               'cur_index'

 L. 241       158  SETUP_EXCEPT        172  'to 172'

 L. 242       160  LOAD_GLOBAL              str
              162  LOAD_FAST                'key'
 ...
 L. 246       188  SETUP_EXCEPT        254  'to 254'

 L. 247       190  LOAD_GLOBAL              hasattr
 ...
 L. 254       270  SETUP_EXCEPT        294  'to 294'

 L. 255       272  LOAD_GLOBAL              str
              274  LOAD_GLOBAL              sys
 ...
 L. 259       310  SETUP_EXCEPT        358  'to 358'

 L. 260       312  LOAD_GLOBAL              str
 ...
 L. 266       374  SETUP_EXCEPT        404  'to 404'

 L. 267       376  LOAD_FAST                'output_file'

...
# Compiled at: 2020-07-10 23:00:01
# Size of source mod 2**32: 93963 bytes
...
def get_buffs_ids_for_outfit--- This code section failed: ---
 ...
 L.1575         0  LOAD_GLOBAL              get_optional_target
                2  LOAD_FAST                'opt_sim'
                4  LOAD_FAST                '_connection'
                6  CALL_FUNCTION_2       2  '2 positional arguments'
                8  STORE_FAST               'sim'

 L.1576        10  LOAD_FAST                'sim'
               12  LOAD_CONST               None
               14  COMPARE_OP               is
               16  POP_JUMP_IF_FALSE    22  'to 22'

 L.1577        18  LOAD_CONST               False
               20  RETURN_VALUE     
             22_0  COME_FROM            16  '16'

 L.1579        22  LOAD_GLOBAL              getattr
 ...
 L.1580        38  LOAD_FAST                'category'
               40  LOAD_CONST               None
               42  COMPARE_OP               is-not
               44  POP_JUMP_IF_FALSE   186  'to 186'

 L.1581        46  LOAD_FAST                'sim'
 ...
 L.1585       108  LOAD_FAST                'buff_guids'
              110  POP_JUMP_IF_FALSE   162  'to 162'

 L.1586       112  SETUP_LOOP          184  'to 184'
              114  LOAD_FAST                'buff_guids'
              116  GET_ITER         
              118  FOR_ITER            158  'to 158'
              120  STORE_FAST               'buff_guid'

 L.1587       122  LOAD_GLOBAL              services
              124  LOAD_METHOD              buff_manager
              126  CALL_METHOD_0         0  '0 positional arguments'
              128  LOAD_METHOD              get
              130  LOAD_FAST                'buff_guid'
              132  CALL_METHOD_1         1  '1 positional argument'
              134  STORE_FAST               'buff_type'

 L.1588       136  LOAD_GLOBAL              sims4
              138  LOAD_ATTR                commands
              140  LOAD_METHOD              output
              142  LOAD_STR                 'buff: {}'
              144  LOAD_METHOD              format
              146  LOAD_FAST                'buff_type'
              148  CALL_METHOD_1         1  '1 positional argument'
              150  LOAD_FAST                '_connection'
              152  CALL_METHOD_2         2  '2 positional arguments'
              154  POP_TOP          
              156  JUMP_BACK           118  'to 118'
              158  POP_BLOCK        
              160  JUMP_ABSOLUTE       238  'to 238'
            162_0  COME_FROM           110  '110'

 L.1590       162  LOAD_GLOBAL              sims4
              164  LOAD_ATTR                commands
              166  LOAD_METHOD              output
              168  LOAD_STR                 'category: {}, index: {}, has no buffs associated'
              170  LOAD_METHOD              format
              172  LOAD_FAST                'outfit_category_string'
              174  LOAD_FAST                'outfit_index'
              176  CALL_METHOD_2         2  '2 positional arguments'
              178  LOAD_FAST                '_connection'
              180  CALL_METHOD_2         2  '2 positional arguments'
              182  POP_TOP          
            184_0  COME_FROM_LOOP      112  '112'
              184  JUMP_FORWARD        238  'to 238'
            186_0  COME_FROM            44  '44'

 L.1592       186  LOAD_STR                 ''
              188  STORE_FAST               'available_categories'

 L.1593       190  SETUP_LOOP          218  'to 218'
              192  LOAD_GLOBAL              OutfitCategory
              194  GET_ITER         
              196  FOR_ITER            216  'to 216'
              198  STORE_FAST               'category'

 L.1594       200  LOAD_FAST                'available_categories'
              202  LOAD_FAST                'category'
              204  LOAD_ATTR                name
              206  BINARY_ADD       
              208  LOAD_STR                 ', '
              210  BINARY_ADD       
              212  STORE_FAST               'available_categories'
              214  JUMP_BACK           196  'to 196'
              216  POP_BLOCK        
            218_0  COME_FROM_LOOP      190  '190'

 L.1595       218  LOAD_GLOBAL              sims4
              220  LOAD_ATTR                commands
              222  LOAD_METHOD              output
              224  LOAD_STR                 'Unrecognized outfit category name. available categories = {}'
              226  LOAD_METHOD              format
              228  LOAD_FAST                'available_categories'
              230  CALL_METHOD_1         1  '1 positional argument'
              232  LOAD_FAST                '_connection'
              234  CALL_METHOD_2         2  '2 positional arguments'
              236  POP_TOP          
            238_0  COME_FROM           184  '184'

 L.1596       238  LOAD_CONST               True
              240  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `COME_FROM_LOOP' instruction at offset 184_0

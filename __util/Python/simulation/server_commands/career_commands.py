...
# Compiled at: 2020-05-16 00:26:19
# Size of source mod 2**32: 31959 bytes
...
import distributor, interactions, random, services, sims4.commands, sims4.log
...
def select_career--- This code section failed: ---
 ...
 L.  40        42  LOAD_CONST               False
               44  RETURN_VALUE     
             46_0  COME_FROM            30  '30'

 L.  42        46  LOAD_GLOBAL              services
 ...
 L.  54       130  LOAD_FAST                'sim_info'
              132  LOAD_CONST               None
              134  COMPARE_OP               is
              136  POP_JUMP_IF_FALSE   152  'to 152'

 L.  55       138  LOAD_GLOBAL              logger
 ...
 L.  62       196  LOAD_CONST               False
              198  RETURN_VALUE     
            200_0  COME_FROM           184  '184'

 L.  64       200  LOAD_FAST                'reason'
              202  LOAD_CONST               None
              204  COMPARE_OP               is
              206  POP_JUMP_IF_FALSE   222  'to 222'

 L.  65       208  LOAD_GLOBAL              logger
 ...
 L.  72       250  LOAD_FAST                'current_career'
              252  LOAD_CONST               None
              254  COMPARE_OP               is-not
          256_258  POP_JUMP_IF_FALSE   272  'to 272'

 L.  75       260  LOAD_FAST                'current_career'
 ...
 L.  78       288  LOAD_GLOBAL              logger
              290  LOAD_ATTR                error
              292  LOAD_STR                 'The career track {} does not have a level {}'

 L.  79       294  LOAD_FAST                'career_track'
              296  LOAD_FAST                'level'
 ...
 L.  80       306  LOAD_CONST               False
              308  RETURN_VALUE     
            310_0  COME_FROM           284  '284'

 L.  84       310  LOAD_FAST                'career_type'
              312  LOAD_FAST                'sim_info'
              314  CALL_FUNCTION_1       1  '1 positional argument'
              316  STORE_FAST               'career'

 L.  85       318  LOAD_FAST                'career_tracker'
              320  LOAD_ATTR                add_career
              322  LOAD_FAST                'career'

 L.  86       324  LOAD_CONST               True

 L.  87       326  LOAD_FAST                'schedule_shift_type'

 L.  88       328  LOAD_FAST                'career_track'
              330  LOAD_ATTR                career_levels
              332  LOAD_FAST                'level'
              334  BINARY_SUBSCR    

 L.  89       336  LOAD_GLOBAL              RewardType
              338  LOAD_ATTR                MONEY
              340  BUILD_TUPLE_1         1 

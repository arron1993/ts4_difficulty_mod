...
# Compiled at: 2020-09-24 02:05:57
# Size of source mod 2**32: 74547 bytes
 ...
 'age', actor_name): age.animation_age_param}
            ...
            if actor_name in self._actors:
                ...
                if Asm._is_same_actor(old_actor, actor) and old_suffix == suffix:
                    ...
                    if old_actor() is None:
                        ...
                        return False
            elif (actor_set or super().set_actor)(actor_name, actor, suffix=suffix, **kwargs):
                self._actors[actor_name] = (
                 actor.ref(), suffix, actor_participant)
                actor_set = True
            else:
    ...
    def add_virtual_actor(self, actor_name, actor, suffix=DEFAULT):
        ...
        if suffix is DEFAULT:
            ...
            elif (actor_set or super().add_virtual_actor)(actor_name, actor, suffix):

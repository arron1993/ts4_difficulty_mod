...
# Compiled at: 2020-07-27 22:09:13
# Size of source mod 2**32: 57814 bytes
...
class ContinuousStatistic(BaseStatistic):
    ...
    def get_time_till_decay_starts(self):
        if self.delayed_decay_rate is None:
            ...
            if (self._time_of_last_value_change is None or self.tracker.owner).is_npc and not self.delayed_decay_rate.npc_decay:

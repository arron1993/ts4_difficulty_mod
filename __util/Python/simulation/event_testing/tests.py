...
# Compiled at: 2020-09-03 21:24:23
# Size of source mod 2**32: 43987 bytes
...
import aspirations.aspiration_tests, business.business_tests, clubs.club_tests, conditional_layers.conditional_layer_tests, drama_scheduler.drama_node_tests, event_testing.constraint_tests, event_testing.game_option_tests, event_testing.resolver, event_testing.results, event_testing.state_tests, event_testing.statistic_tests, event_testing.test_based_score_threshold, event_testing.test_variants, gsi_handlers, objects.footprint_tests, objects.gardening.gardening_tests, objects.object_tests, organizations.organization_tests, relationships.relationship_tests, restaurants.restaurant_tests, retail.retail_tests, routing.formation.formation_tests, server.online_tests, services, sickness.sickness_tests, sims.households.household_tests, sims.sim_info_tests, sims.swim_location_test, sims.unlock_tracker_tests, sims4.log, sims4.repr_utils, sims4.tuning.instance_manager, sims4.tuning.tunable, sims4.utils, socials.social_tests, statistics.skill_tests, temple.temple_tests, travel_group.travel_group_tests, vet.vet_clinic_tests, world.floor_feature_test, world.pick_tests, world.pool_size_test, world.world_tests, zone_tests
...
class TunableTestVariant(sims4.tuning.tunable.TunableVariant):
    TEST_VARIANTS = {'active_routing_objects':objects.object_tests.ActiveRoutingObjectsTest.TunableFactory, 

...
# Compiled at: 2020-07-27 22:12:22
# Size of source mod 2**32: 62090 bytes
...
class ParticipantStartedInteractionTest(event_testing.test_base.BaseTest):
    ...
    FACTORY_TUNABLES = {'description':'Check to see if the Sim started an affordance as a particular actor', 
     'participant':TunableEnumEntry(ParticipantType, ParticipantType.Actor, description='This is the role the sim in question should be to pass.'), 
     'affordances':TunableList(TunableReference(services.affordance_manager()), description="The Sim must have started either any affordance in this list or an interaction matching one of the tags in this tunable's Tags field."), 
...
class TotalRelationshipBitTest(event_testing.test_base.BaseTest):
    ...
    FACTORY_TUNABLES = {'description':'Gate availability by a relationship status.', 
     ...
     'relationship_bits':TunableSet(TunableReference((services.relationship_bit_manager()), description='The relationship bit that will be checked.', class_restrictions='RelationshipBit')), 

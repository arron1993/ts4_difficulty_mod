...
# Compiled at: 2020-10-07 01:06:34
# Size of source mod 2**32: 241028 bytes
...
class CollectionThresholdTest(event_testing.test_base.BaseTest):
 ...
 L. 142         0  LOAD_FAST                'test_targets'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_FALSE    18  'to 18'

 L. 143         8  LOAD_GLOBAL              TestResult
               10  LOAD_CONST               False
 ...
 L. 157       116  SETUP_LOOP          188  'to 188'
 ...
 L. 158       130  LOAD_FAST                'collection_id'
 ...
 L. 159       144  LOAD_FAST                'collection_tracker'
 ...
 L. 160       154  LOAD_FAST                'curr_value'
              156  LOAD_CONST               1
              158  INPLACE_ADD      
 ...
 L. 162       168  LOAD_FAST                'collection_tracker'
 ...
 L. 163       180  LOAD_FAST                'curr_value'
              182  LOAD_CONST               1
              184  INPLACE_ADD      
 ...
 L. 166       208  SETUP_LOOP          296  'to 296'
 ...
 L. 167       222  LOAD_FAST                'collection_id'
 ...
 L. 168       236  LOAD_FAST                'collection_tracker'
 ...
 L. 169       250  LOAD_FAST                'curr_value'
 ...
 L. 171       268  LOAD_FAST                'collection_tracker'
 ...
 L. 172       284  LOAD_FAST                'curr_value'
 ...
 L. 175       314  LOAD_GLOBAL              TestResult
              316  LOAD_ATTR                TRUE
              318  RETURN_VALUE     
            320_0  COME_FROM           310  '310'

 L. 177       320  LOAD_GLOBAL              Operator
 ...
 L. 178       336  LOAD_GLOBAL              TestResultNumeric
              338  LOAD_CONST               False
              340  LOAD_STR                 '{} failed collection check: {} {} {}'

 L. 179       342  LOAD_FAST                'self'
              344  LOAD_ATTR                who
              346  LOAD_ATTR                name

 L. 180       348  LOAD_FAST                'curr_value'

 L. 181       350  LOAD_FAST                'operator_symbol'

 L. 182       352  LOAD_FAST                'self'
              354  LOAD_ATTR                threshold
              356  LOAD_ATTR                value

 L. 183       358  LOAD_FAST                'curr_value'

 L. 184       360  LOAD_FAST                'self'
              362  LOAD_ATTR                threshold
              364  LOAD_ATTR                value

 L. 185       366  LOAD_CONST               False

 L. 186       368  LOAD_FAST                'self'
    ...
    def __call__(self, participants={}, targets={}):
        for participant in participants:
            if not participant.is_sim:
                ...
                return self._count.compare(household_size) or TestResult(False, "Household doesn't meet size requirements.",
                  tooltip=(self.tooltip))
    ...
    def __call__(self, subjects, tooltip=None):
        for subject in subjects:
            if self.career is None:
                ...
                return self.threshold.compare(days_worked) or TestResult(False, 'Threshold not met. Sim: {}, Career: {}, Threshold: {}', subject, career, self.threshold)
...
class CareerTimeUntilWorkTestFactory(SpecifiedCareerMixin, HasTunableSingletonFactory, AutoFactoryInit):
 ...
 L.3633         0  SETUP_LOOP          252  'to 252'
                2  LOAD_FAST                'subjects'
                4  GET_ITER         
                6  FOR_ITER            250  'to 250'
                8  STORE_FAST               'subject'

 L.3634        10  LOAD_FAST                'self'
               12  LOAD_ATTR                check_all_careers
               14  POP_JUMP_IF_FALSE    44  'to 44'

 L.3635        16  LOAD_FAST                'subject'
               18  LOAD_ATTR                careers
               20  LOAD_METHOD              values
               22  CALL_METHOD_0         0  '0 positional arguments'
               24  STORE_FAST               'careers_to_check'

 L.3636        26  LOAD_FAST                'careers_to_check'
               28  POP_JUMP_IF_TRUE     90  'to 90'

 L.3637        30  LOAD_GLOBAL              TestResult
               32  LOAD_CONST               False
               34  LOAD_STR                 '{} does not have any career to check if there is time to work.'
               36  LOAD_FAST                'subject'
               38  CALL_FUNCTION_3       3  '3 positional arguments'
               40  RETURN_VALUE     
               42  JUMP_FORWARD         90  'to 90'
             44_0  COME_FROM            14  '14'

 L.3639        44  LOAD_FAST                'subject'
               46  LOAD_ATTR                careers
               48  LOAD_METHOD              get
               50  LOAD_FAST                'career_id'
               52  CALL_METHOD_1         1  '1 positional argument'
               54  STORE_FAST               'this_career'

 L.3640        56  LOAD_FAST                'this_career'
               58  LOAD_CONST               None
               60  COMPARE_OP               is
               62  POP_JUMP_IF_FALSE    84  'to 84'

 L.3641        64  LOAD_GLOBAL              TestResult
               66  LOAD_CONST               False
               68  LOAD_STR                 '{0} does not have the career needed for this interaction: {1}:{2}'
               70  LOAD_FAST                'subject'
               72  LOAD_FAST                'self'
               74  LOAD_ATTR                career
               76  LOAD_FAST                'self'
               78  LOAD_ATTR                hours_till_work
               80  CALL_FUNCTION_5       5  '5 positional arguments'
               82  RETURN_VALUE     
             84_0  COME_FROM            62  '62'

 L.3642        84  LOAD_FAST                'this_career'
               86  BUILD_TUPLE_1         1 
               88  STORE_FAST               'careers_to_check'
             90_0  COME_FROM            42  '42'
             90_1  COME_FROM            28  '28'

 L.3643        90  SETUP_LOOP          248  'to 248'
               92  LOAD_FAST                'careers_to_check'
               94  GET_ITER         
               96  FOR_ITER            246  'to 246'
               98  STORE_FAST               'career'

 L.3644       100  LOAD_CONST               None
              102  STORE_FAST               'hours'

 L.3645       104  LOAD_FAST                'career'
              106  LOAD_ATTR                is_work_time
              108  POP_JUMP_IF_FALSE   150  'to 150'

 L.3646       110  LOAD_FAST                'career'
              112  LOAD_ATTR                start_time
              114  LOAD_GLOBAL              services
              116  LOAD_METHOD              time_service
              118  CALL_METHOD_0         0  '0 positional arguments'
              120  LOAD_ATTR                sim_now
              122  BINARY_SUBTRACT  
              124  STORE_FAST               'elapsed'

 L.3647       126  LOAD_FAST                'elapsed'
              128  LOAD_METHOD              in_hours
              130  CALL_METHOD_0         0  '0 positional arguments'
              132  STORE_FAST               'hours'

 L.3648       134  LOAD_FAST                'hours'
              136  LOAD_FAST                'self'
              138  LOAD_ATTR                hours_till_work
              140  LOAD_ATTR                lower_bound
              142  COMPARE_OP               <
              144  POP_JUMP_IF_FALSE   150  'to 150'

 L.3649       146  LOAD_CONST               None
              148  STORE_FAST               'hours'
            150_0  COME_FROM           144  '144'
            150_1  COME_FROM           108  '108'

 L.3650       150  LOAD_FAST                'hours'
              152  LOAD_CONST               None
              154  COMPARE_OP               is
              156  POP_JUMP_IF_FALSE   180  'to 180'

 L.3651       158  LOAD_FAST                'career'
              160  LOAD_METHOD              get_next_work_time
              162  CALL_METHOD_0         0  '0 positional arguments'
              164  UNPACK_SEQUENCE_3     3 
              166  STORE_FAST               'time_span'
              168  STORE_FAST               '_'
              170  STORE_FAST               '_'

 L.3652       172  LOAD_FAST                'time_span'
              174  LOAD_METHOD              in_hours
              176  CALL_METHOD_0         0  '0 positional arguments'
              178  STORE_FAST               'hours'
            180_0  COME_FROM           156  '156'

 L.3653       180  LOAD_FAST                'self'
              ...
              200  LOAD_ATTR                upper_bound
              202  COMPARE_OP               <=
              204  POP_JUMP_IF_FALSE   214  'to 214'
              206  JUMP_BACK            96  'to 96'
            208_0  COME_FROM           194  '194'
              208  POP_TOP          
              210  JUMP_FORWARD        214  'to 214'

 L.3654       212  CONTINUE             96  'to 96'
            214_0  COME_FROM           210  '210'
            214_1  COME_FROM           204  '204'

 L.3655       214  LOAD_GLOBAL              TestResultNumeric
              216  LOAD_CONST               False
              218  LOAD_STR                 '{0} does not currently have the correct hours till work in career ({1},{2}) required to pass this test'

 L.3656       220  LOAD_FAST                'subject'
              222  LOAD_FAST                'career'
              224  LOAD_FAST                'self'
              226  LOAD_ATTR                hours_till_work

 L.3657       228  LOAD_FAST                'hours'

 L.3658       230  LOAD_FAST                'self'
              232  LOAD_ATTR                hours_till_work
              234  LOAD_ATTR                lower_bound

 L.3659       236  LOAD_CONST               False

 L.3660       238  LOAD_FAST                'tooltip'
              240  LOAD_CONST               ('current_value', 'goal_value', 'is_money', 'tooltip')
              242  CALL_FUNCTION_KW_9     9  '9 total positional and keyword args'
              244  RETURN_VALUE     
              246  POP_BLOCK        
            248_0  COME_FROM_LOOP       90  '90'
              248  JUMP_BACK             6  'to 6'
              250  POP_BLOCK        
            252_0  COME_FROM_LOOP        0  '0'

 L.3662       252  LOAD_GLOBAL              TestResult
              254  LOAD_ATTR                TRUE
              256  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `POP_TOP' instruction at offset 208
        ...
        for subject in subjects:
            ...
            if not subject.careers.values():
                ...
                for this_career in subject.careers.values():
                    if not self.career is DEFAULT:
                        if isinstance(this_career, self.career):
                            if this_career.is_visible_career or self.allow_invisible_careers:
                                if type(this_career) in self.blacklist:
                                    continue
                                if self.user_level:
                                    current_value = this_career.user_level >= self.user_level.lower_bound and this_career.user_level <= self.user_level.upper_bound or this_career.user_level
                                    continue
                        break
                else:
                    if self.user_level:

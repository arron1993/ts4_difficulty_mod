...
# Compiled at: 2018-01-25 00:32:27
# Size of source mod 2**32: 7335 bytes
...
class CountdownState(CommonSituationState):
    FACTORY_TUNABLES = {'countdown_affordance':TunableReference(manager=services.affordance_manager()), 
     'count_mixer':TunableReference(manager=services.affordance_manager()), 

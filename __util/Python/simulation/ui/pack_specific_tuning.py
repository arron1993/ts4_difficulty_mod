...
# Compiled at: 2019-10-30 16:23:09
    ...
    if remapped_keys is not None:
        for stripped_key, pack_specific_key in remapped_keys.items():
            if pack_specific_key.group != 0:
                ...
                if venue_tuning is not None and venue_tuning.visible_in_map_view and not venue_tuning.hide_from_buildbuy_ui:
                    if value.get(venue_tuning) is None:

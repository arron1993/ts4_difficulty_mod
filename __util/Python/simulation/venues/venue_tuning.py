...
# Compiled at: 2020-07-29 23:27:51
# Size of source mod 2**32: 62332 bytes
...
class Venue(metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.VENUE)):
    ...
    def __init__(self, source_venue_type=None, **kwargs):
        ...
        elif source_venue_type is None or source_venue_type.variable_venues is None:
            self._civic_policy_provider = None
 ...
 L.1206         0  BUILD_LIST_0          0 
                2  STORE_FAST               'failure_reasons'

 L.1207         4  SETUP_LOOP           50  'to 50'
                6  LOAD_FAST                'cls'

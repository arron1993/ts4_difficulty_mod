...
# Compiled at: 2020-08-07 04:04:37
...
import filters.tunable, itertools, services, sims4.resources, situations, random
...
lock_instance_tunables(EmployeeFestivalSituationState, exclusivity=(BouncerExclusivityCategory.FESTIVAL_GOER),
  creation_ui_option=(SituationCreationUIOption.NOT_AVAILABLE),
  _implies_greeted_status=False)

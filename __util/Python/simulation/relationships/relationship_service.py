...
# Compiled at: 2020-10-23 02:13:10
# Size of source mod 2**32: 83107 bytes
import itertools
...
class RelationshipService(Service):
 ...
 L. 375         0  LOAD_FAST                'target_sim_id'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_FALSE    38  'to 38'

 L. 376         8  SETUP_LOOP           66  'to 66'
               10  LOAD_FAST                'self'
 ...
 L. 377        24  LOAD_FAST                'relationship'
 ...
 L. 380        50  LOAD_FAST                'relationship'
               52  LOAD_CONST               None
               54  COMPARE_OP               is-not
               56  POP_JUMP_IF_FALSE    66  'to 66'

 L. 381        58  LOAD_FAST                'relationship'
...
Parse error at or near `COME_FROM' instruction at offset 66_1
    ...
    def on_all_households_and_sim_infos_loaded(self, client):
        ...
        for sim_ids, relationship in tuple(self._relationships.items()):
            ...
            if not sim_info_a is None:
                ...
                if sim_info_a.lod == SimInfoLODLevel.MINIMUM or sim_info_b.lod == SimInfoLODLevel.MINIMUM:
 ...
 L. 771         0  BUILD_LIST_0          0 
                2  STORE_FAST               'bits'

 L. 772         4  LOAD_FAST                'target_sim_id'
                6  LOAD_CONST               None
                8  COMPARE_OP               is
               10  POP_JUMP_IF_FALSE    50  'to 50'

 L. 773        12  SETUP_LOOP           86  'to 86'
               14  LOAD_FAST                'self'
 ...
 L. 777        62  LOAD_FAST                'relationship'
               64  LOAD_CONST               None
               66  COMPARE_OP               is-not
               68  POP_JUMP_IF_FALSE    86  'to 86'

 L. 778        70  LOAD_FAST                'bits'
...
Parse error at or near `COME_FROM_LOOP' instruction at offset 86_2
 ...
 L.1379         0  LOAD_FAST                'obj_tag_set'
                2  LOAD_CONST               None
                4  COMPARE_OP               is
                6  POP_JUMP_IF_FALSE    38  'to 38'

 L.1380         8  SETUP_LOOP           66  'to 66'
               10  LOAD_FAST                'self'
 ...
 L.1381        24  LOAD_FAST                'obj_relationship'
               26  LOAD_METHOD              send_object_relationship_info
               28  CALL_METHOD_0         0  '0 positional arguments'
               30  POP_TOP          
               32  JUMP_BACK            20  'to 20'
               34  POP_BLOCK        
 ...
 L.1384        50  LOAD_FAST                'obj_relationship'
               52  LOAD_CONST               None
               54  COMPARE_OP               is-not
               56  POP_JUMP_IF_FALSE    66  'to 66'

 L.1385        58  LOAD_FAST                'obj_relationship'
               60  LOAD_METHOD              send_object_relationship_info
               62  CALL_METHOD_0         0  '0 positional arguments'
               64  POP_TOP          
             66_0  COME_FROM            56  '56'
             66_1  COME_FROM            36  '36'
...
Parse error at or near `COME_FROM' instruction at offset 66_1
 ...
 L.1473         4  LOAD_FAST                'obj_tag_set'
                6  LOAD_CONST               None
                8  COMPARE_OP               is
               10  POP_JUMP_IF_FALSE    50  'to 50'

 L.1474        12  SETUP_LOOP           86  'to 86'
               14  LOAD_FAST                'self'
 ...
 L.1478        62  LOAD_FAST                'relationship'
               64  LOAD_CONST               None
               66  COMPARE_OP               is-not
               68  POP_JUMP_IF_FALSE    86  'to 86'

 L.1479        70  LOAD_FAST                'bits'
               72  LOAD_METHOD              extend
               74  LOAD_FAST                'relationship'
               76  LOAD_METHOD              get_bits
               78  LOAD_FAST                'actor_sim_id'

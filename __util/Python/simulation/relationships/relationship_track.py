...
# Compiled at: 2020-10-20 04:07:52
# Size of source mod 2**32: 51304 bytes
...
class RelationshipTrack(BaseRelationshipTrack, TunedContinuousStatistic, HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.statistic_manager()):
 ...
 L. 836         0  LOAD_CONST               None
                2  RETURN_VALUE     

 L. 841         4  FOR_ITER             64  'to 64'
                6  STORE_FAST               'statistic'

 L. 843         8  LOAD_GLOBAL              issubclass
 ...
 L. 844        18  CONTINUE              4  'to 4'
             20_0  COME_FROM            16  '16'

 L. 847        20  LOAD_FAST                'statistic'
 ...
 L. 848        32  CONTINUE              4  'to 4'
             34_0  COME_FROM            30  '30'

 L. 852        34  LOAD_FAST                'statistic'
               36  LOAD_ATTR                display_priority
               38  LOAD_CONST               0
               40  COMPARE_OP               ==
               42  POP_JUMP_IF_FALSE    46  'to 46'

 L. 853        44  CONTINUE              4  'to 4'
             46_0  COME_FROM            42  '42'

 L. 855        46  LOAD_FAST                'relationship_track_display_priority'
 ...
 L. 859        66  SETUP_LOOP          110  'to 110'
 ...
 L. 861        92  CONTINUE             76  'to 76'
             94_0  COME_FROM            90  '90'

 L. 865        94  LOAD_GLOBAL              logger

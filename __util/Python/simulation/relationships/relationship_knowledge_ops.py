...
# Compiled at: 2020-08-19 20:17:01
# Size of source mod 2**32: 12250 bytes
import random
...
class KnowOtherSimTraitOp(BaseTargetedLootOperation):
 ...
 L. 139        14  SETUP_LOOP          152  'to 152'
               16  LOAD_FAST                'self'
               18  LOAD_ATTR                traits
 ...
 L. 141        40  LOAD_GLOBAL              logger
               42  LOAD_ATTR                error

 L. 142        44  LOAD_STR                 "{}: Tuned to get knowledge of trait {}, whose type {} is not allowed. Look at 'Knowledge Trait Types' in trait_tracker for the valid types."

 L. 143        46  LOAD_FAST                'interaction'
 ...
 L. 146       100  SETUP_LOOP          152  'to 152'
              102  LOAD_FAST                'self'
 ...
 L. 147       114  LOAD_FAST                'trait_type'
              116  LOAD_FAST                'trait_tracker'
              118  LOAD_ATTR                KNOWLEDGE_TRAIT_TYPES
              120  COMPARE_OP               not-in
              122  POP_JUMP_IF_FALSE   110  'to 110'

 L. 148       124  LOAD_GLOBAL              logger
              126  LOAD_ATTR                error

 L. 149       128  LOAD_STR                 "{}: Tuned to get knowledge of trait of type {}, which is not allowed. Look at 'Knowledge Trait Types' in trait_tracker for the valid types."

 L. 150       130  LOAD_FAST                'interaction'

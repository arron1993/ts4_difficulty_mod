...
# Compiled at: 2020-10-08 23:23:14
# Size of source mod 2**32: 38151 bytes
...
class LocationTest(HasTunableSingletonFactory, AutoFactoryInit, BaseTest):
    ...
    def location_tests(is_outside=True, is_inside_building=True, is_natural_ground=True, is_in_slot=True, is_venue_type=True, is_on_active_lot=True, in_common_area=True, is_fire_allowed=True, is_on_level=True, has_terrain_tag=True, valid_surface_types=True):
        locked_args = {}
        if not is_outside:

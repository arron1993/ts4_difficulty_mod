...
# Compiled at: 2020-04-23 00:12:37
# Size of source mod 2**32: 18955 bytes
...
from sims4.tuning.tunable import HasTunableFactory, TunableList, TunableTuple, AutoFactoryInit, TunableVariant, TunableSingletonFactory, TunableSimMinute, HasTunableSingletonFactory, TunablePercent, TunableRange, TunableSet, TunableReference
...
class TunableObjectModifyGlobalTestVariant(TunableVariant):
    ...
    def __init__(self, additional_tests=None, **kwargs):
        ...
        (super().__init__)(season=seasons.season_tests.SeasonTest.TunableFactory(locked_args={'tooltip': None}), 
         ...
         zone=ZoneTest.TunableFactory(locked_args={'tooltip': None}), **kwargs)

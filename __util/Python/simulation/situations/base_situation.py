...
# Compiled at: 2020-10-13 19:17:31
# Size of source mod 2**32: 125708 bytes
...
import build_buy, distributor.ops, enum, gsi_handlers, id_generator, interactions.context, services, sims4.log, telemetry_helper
    ...
    def set_job_uniform(self, sim, job, outfit_for_clothing_change=None):
        ...
        if outfit_generators:
            ...
            if should_generate_outfit:
                ...
                if found_outfit:
                    OutfitGenerator.generate_outfit(outfit_generator, (sim.sim_info), (OutfitCategory.SITUATION), outfit_index=0)
            elif not found_outfit:
                return
                ...
                if not self.manager.sim_being_created is sim:
                    if services.current_zone().is_zone_running or outfit_for_clothing_change is None:

...
# Compiled at: 2020-04-01 22:38:44
    ...
    def responses(self):
        if self.bring_other_sims is not None:
            return (
             ...
             UiDialogResponse(dialog_response_id=(NPCHostedSituationDialog.BRING_OTHER_SIMS_RESPONSE_ID), text=(self.bring_other_sims.text),
               ui_request=(UiDialogResponse.UiDialogUiRequest.NO_REQUEST)),

...
# Compiled at: 2020-05-05 19:44:27
# Size of source mod 2**32: 43678 bytes
...
class InteractionOfInterest(AutoFactoryInit):
    FACTORY_TUNABLES = {'affordances':TunableList(description="\n            The Sim must have started either any affordance in this list or an\n            interaction matching one of the tags in this tunable's Tags\n            field.\n            ",
       tunable=TunableReference((services.affordance_manager()), pack_safe=True)), 
...
class SituationJobAndRoleState:
    FACTORY_TUNABLES = {'situation_job':TunableReference(services.situation_job_manager(), description='A reference to a SituationJob that can be performed at this Situation.'), 
     'role_state':TunableReference(services.get_instance_manager(sims4.resources.Types.ROLE_STATE), description='A role state the sim assigned to the job will perform')}

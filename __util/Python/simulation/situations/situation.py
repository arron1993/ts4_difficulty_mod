...
# Compiled at: 2020-09-01 02:03:05
# Size of source mod 2**32: 63694 bytes
...
import alarms, build_buy, clock, event_testing.resolver, event_testing.test_variants, services, sims.sim_info_tests, sims4.log, sims4.resources, situations.bouncer.bouncer_types, statistics.skill_tests, travel_group.travel_group_tests, ui.screen_slam
...
class Situation(SituationGoalTuningMixin, SituationLevelDataTuningMixin, BaseSituation, HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.SITUATION)):
    ...
    INSTANCE_TUNABLES = {'category':TunableEnumEntry(description='\n                The Category that the Situation belongs to.\n                ',
     ...
     'job_display_ordering':OptionalTunable(description='\n            An optional list of the jobs in the order you want them displayed\n            in the Plan an Event UI.\n            ',
       tunable=TunableList(tunable=TunableReference(manager=(services.situation_job_manager()))),
       tuning_group=GroupNames.UI), 
     ...
     'scoring_lock_reason':OptionalTunable(description="\n            If enabled, when the situation is shown in social event UI, the \n            'Goaled Event' checkbox will be greyed out and can't be changed.\n            This reason text will be shown as a tooltip.\n            ",
       ...
       tuning_group=GroupNames.UI), 
     'recommended_job_object_notification':ui.ui_dialog_notification.UiDialogNotification.TunableFactory(description='\n            The notification that is displayed when one or more recommended objects\n            for a job are missing.\n            ',
    ...
    SITUATION_USER_FACING_REMOVE_INSTANCE_TUNABLES = ('_display_name', 'travel_request_behavior',
    ...
    SITUATION_EVENT_REMOVE_INSTANCE_TUNABLES = ('_buff', '_cost', 'venue_invitation_message',
                                                ...
                                                '_display_name', 'screen_slam_gold',
                                                'screen_slam_silver', 'screen_slam_bronze',
                                                'screen_slam_no_medal', 'force_invite_only',
                                                'recommended_job_object_notification',

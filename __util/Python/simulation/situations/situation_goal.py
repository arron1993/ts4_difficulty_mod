...
# Size of source mod 2**32: 43196 bytes
import random
...
import buffs.buff_ops, enum, event_testing.state_tests, event_testing.test_variants, event_testing.tests, objects.object_tests, services, sims.sim_info_tests, sims4.resources, situations, statistics.skill_tests, world.world_tests, zone_tests
...
class SituationGoal(SituationGoalDisplayMixin, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.SITUATION_GOAL)):
    ...
    def get_localization_tokens(self):
        target_sim_info = self.get_required_target_sim_info()
        return (self.numerical_token, self._sim_info, target_sim_info, self._secondary_sim_info)

...
# Compiled at: 2020-06-15 22:54:31
# Size of source mod 2**32: 36853 bytes
import random
...
import buffs.tunable, build_buy, element_utils, event_testing.results, fishing.fish_object, interactions.base.immediate_interaction, interactions.base.mixer_interaction, interactions.base.super_interaction, interactions.utils.outcome, interactions.utils.outcome_enums, objects.system, services, sims4.collections, sims4.localization, sims4.log, sims4.tuning.tunable, singletons, tag, tunable_multiplier, ui.ui_dialog_notification
...
class FishingLocationExamineWaterSuperInteraction(FishingLocationSuperInteraction):
    ...
    BAIT_NOTIFICATION_TEXT_MAP = sims4.tuning.tunable.TunableMapping(key_type=sims4.tuning.tunable.TunableReference(manager=(services.buff_manager()),
      pack_safe=True),
      key_name='Bait Buff',

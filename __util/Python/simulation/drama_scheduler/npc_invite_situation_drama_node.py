...
# Compiled at: 2020-06-12 17:04:23
# Size of source mod 2**32: 24111 bytes
import random
...
class NPCInviteSituationDramaNode(BaseDramaNode):
    ...
    def _run(self):
        ...
        self._choose_dialog()
        dialog = self._chosen_dialog((self._receiver_sim_info), target_sim_id=(self._sender_sim_info.id),
